...
a.put = n.function(n.seq(n.array(n.lookup(n.item())), n.item(), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $position = a[1];
	let $member = a[2];
...
a.foldLeft = n.function(n.seq(n.array(n.lookup(n.item())), n.item(), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $zero = a[1];
	let $function = a[2];
	return a.foldLeft($array, $zero, $function, array.size($array));
});
a.foldLeft = n.function(n.seq(n.array(n.lookup(n.item())), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $zero = a[1];
	let $function = a[2];
	let $s = a[3];
...
a.foldLeftAt = n.function(n.seq(n.array(n.lookup(n.item())), n.item(), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $zero = a[1];
	let $function = a[2];
	return a.foldLeftAt($array, $zero, $function, 1);
});
a.foldLeftAt = n.function(n.seq(n.array(n.lookup(n.item())), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $zero = a[1];
	let $function = a[2];
	let $at = a[3];
...
a.foldLeftAt = n.function(n.seq(n.array(n.lookup(n.item())), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $zero = a[1];
	let $function = a[2];
	let $at = a[3];
...
a.foldRight = n.function(n.seq(n.array(n.lookup(n.item())), n.item(), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $zero = a[1];
	let $function = a[2];
	return a.foldRight($array, $zero, $function, array.size($array));
});
a.foldRight = n.function(n.seq(n.array(n.lookup(n.item())), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $zero = a[1];
	let $function = a[2];
	let $s = a[3];
...
a.foldRightAt = n.function(n.seq(n.array(n.lookup(n.item())), n.item(), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $zero = a[1];
	let $function = a[2];
	return a.foldRightAt($array, $zero, $function, array.size($array));
});
a.foldRightAt = n.function(n.seq(n.array(n.lookup(n.item())), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $zero = a[1];
	let $function = a[2];
	let $at = a[3];
...
a.forEach = n.function(n.seq(n.array(n.lookup(n.item())), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $function = a[1];
	return a.forEach($array, $function, n.array());
});
a.forEach = n.function(n.seq(n.array(n.lookup(n.item())), n.item(), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $function = a[1];
	let $ret = a[2];
...
a.forEachAt = n.function(n.seq(n.array(n.lookup(n.item())), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $function = a[1];
	return a.forEachAt($array, $function, n.array(), 1);
});
a.forEachAt = n.function(n.seq(n.array(n.lookup(n.item())), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $array = a[0];
	let $function = a[1];
	let $ret = a[2];
	let $at = a[3];
...
a.last = n.function(n.seq(n.array(n.lookup(n.item()))), n.item()), ((...a) => {
	let $array = a[0];
	return array.get($array, array.size($array));
});
a.pop = n.function(n.seq(n.array(n.lookup(n.item()))), n.item()), ((...a) => {
	let $array = a[0];
	return array.remove($array, array.size($array));
});
a.firstIndexOf = n.function(n.seq(n.array(n.lookup(n.item())), n.occurs(n.item(), n.zeroOrOne())), n.item()), ((...a) => {
	let $array = a[0];
	let $lookup = a[1];
...
a.lastIndexOf = n.function(n.seq(n.array(n.lookup(n.item())), n.occurs(n.item(), n.zeroOrOne())), n.item()), ((...a) => {
	let $array = a[0];
	let $lookup = a[1];

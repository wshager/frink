...
dawg.loop$6 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("entry", $(1)),
		...
		await n.when(n.gt(array.size($("entry")), 0)) ? ($("a", array.head($("entry"))),
			...
			await n.when(n.boolean($("isEntry"))) ? ($("has", await n.when(n.boolean($("isEntry"))) ? (dawg.matchPos($("a"), $("pos"), $("cp"))) : (n.false())),
				...
				dawg.loop(array.tail($("entry")), $("ret"), $("cp"), $("word"), $("pos"), $("path"))) : (await n.when(map.contains($("a"), $("cp"))) ? (array.array($("a").call($, $("cp")), $("path"))) : (dawg.loop(array.tail($("entry")), $("ret"), $("cp"), $("word"), $("pos"), $("path"))))) : (array.array($("ret"), $("path")))
}));
...
dawg.find$4 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("entry", $(1)),
		...
		(await n.when(dawg.matchPos($("entry"), $("pos"), $("cp"))) ? ($("len", array.size($("path"))),
			$("path", await n.when(n.or(n.eq($("len"), 0), n.ne($("path").call($, $("len")).call($, "_v"), $("entry").call($, "_v")))) ? (array.append($("path"), $("entry"))) : ($("path"))),
			array.array($("entry"), $("path"))) : (array.array(array.filter($("path"), n.typed(n.function(n.seq(n.item()), n.item()), (async function(...$) {
			$ = n.frame($);
			return $("entry", $(1)),
				dawg.matchPos($("entry"), $("pos"), $("cp"))
		}))), array.array()))) : (array.array($("entry").call($, $("cp")), $("path"))))
}));
dawg.backtrack = (...$) => {
	const $len = $.length;

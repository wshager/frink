...
xqc.analyzeChars$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	...
	/* TODO:
		 ...
		 */
	$("flags", map.merge(n.seq($("params"), map.map(n.pair("xq-compat", n.eq($("params").call($, "$compat"), "xquery")), n.pair("char", n.head($("chars"))), n.pair("type", 0), n.pair("buffer", ""), n.pair("string", 0), n.pair("var", n.false()), n.pair("ws", n.false()), n.pair("number", n.false()), n.pair("comment", n.false()), n.pair("opentag", n.false()), n.pair("closetag", n.false()), n.pair("attrkey", n.false()), n.pair("attrval", n.false()), n.pair("enc-expr", n.false()), n.pair("has-quot", 0), n.pair("opencount", 0), n.pair("r", array.array()), n.pair("d", 1), n.pair("o", array.array()), n.pair("i", map.map()), n.pair("p", array.array()), n.pair("out", array.array()))))),
	xqc.charReducer(n.foldLeft(n.tail($("chars")), $("flags"), xqc.charReducer), "").call($, "out");
}));
xqc.detectCxf = (...$) => {
	const $len = $.length;

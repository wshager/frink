...
xqc.operatorTrie = n.typed(n.item(),n.jsonDoc("/db/apps/raddle.xq/operator-trie.json"));
...
xqc.detectCxf$1 = n.typed(n.function(n.seq(n.item()), n.item()), ((...a) => {
	...
	return a.foldLeftAt($sub, array.array(), n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
		...
		let $x = a[1];
		let $at = a[2];
		return n.forEach(n.and(n.eq($x("t"), "6"), n.geq($x("v"), xqc.cxf0)), test => {
			if (test) {
				...
				return n.forEach(n.or($dotless, $dot), test => {
					if (test) {
...
xqc.replaceDotless$3 = n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
	...
	return a.foldRightAt($cxfs, $r, n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
		...
		return n.forEach(n.boolean($cxf("dotless")), test => {
			if (test) {
				...
				if (test) {
					return n.forEach(xqc.isQname($s), test => {
						if (test) {
							...
							return n.forEach(n.eq(n.xFilter($s, ((...a) => {
	...
	return n.forEach(n.empty($last), test => {
		if (test) {
			...
			return n.forEach(n.and(n.eq($last("t"), "9"), n.gt($size, "0")), test => {
				if (test) {
					return xqc.guardedGet($r, n.minus($size, 1));
				} else {
					return $last;
				}
			});
...
xqc.unwrap$6 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
						...
						if (test) {
							return n.forEach(n.eq($ov, 210), test => {
								if (test) {
									...
									return n.forEach(n.and(n.gt($ov, 2100), n.lt($ov, 2200)), test => {
										if (test) {
											return 2100;
										} else {
	...
	$r = n.forEach(n.and(n.eq($has, 208), n.eq($isLetInElse, n.false())), test => {
		if (test) {
			return array.append($r, xqc.tpl(2, $d, 4));
		} else {
			return n.forEach(n.and($matching, n.eq($has, 2001)), test => {
				if (test) {
					let $index = $i($d);
					...
					return n.forEach(n.boolean($hasCxf), test => {
						if (test) {
							return xqc.replaceDotless($r, n.minus($index, 1), $cxfs);
						} else {
							return array.join(n.seq(array.subarray($r, 1, n.minus($index, 1)), array.array(xqc.tpl(4, $d, "geq"), xqc.tpl(1, $d, 1), xqc.tpl(6, $d, "position"), xqc.tpl(1, $d, 1), xqc.tpl(13, $d, "."), xqc.tpl(2, $d, 2), xqc.tpl(3, $d, ",")), xqc.replaceDotless(array.subarray($r, $index), 0, $cxfs), array.array(xqc.tpl(2, $d, 2))));
						}
					});
				} else {
					return $r;
	...
	return n.forEach(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.eq($osize, "0"), $pass), $hasAss), $isBody), $isLetInElse), $hasTypesig), $hasParam), $hasAf), $matching), $closeThen), $isXret), $hasXret), $isX), $hasX), $hasXfor), $hasConstr), $hasTuple), n.eq($has, 11)), test => {
		if (test) { /*            let $nu := console:log("stop")*/
																			...
																			return n.forEach(n.or(n.or($pass, $closeThen), $hasXfor), test => {
																				if (test) {
																					...
																					return n.forEach(n.boolean($hasAss), test => {
																						if (test) {
																							return n.forEach(n.and($isLet, n.eq(xqc.guardedGet($r, $size)("t"), "3")), test => {
																								if (test) {
																									return n.seq();
																								} else {
			...
			let $o = n.forEach(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or($hasParam, $hasConstr), n.seq(n.and($hasAss, n.ne(xqc.guardedGet($r, $size)("t"), "3")))), $isBody), $hasAf), $matching), $closeThen), $isXret), $isX), $hasTuple), test => {
				if (test) {
					return a.pop($o);
				} else {
					return $o;
			...
			return map.map(n.pair("r", n.forEach(n.exists($tpl), test => {
				if (test) {
...
xqc.rtp$9 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.integer(), n.array(n.occurs(n.item(), n.zeroOrMore())), n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.array(n.occurs(n.item(), n.zeroOrMore())), n.occurs(n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.zeroOrMore()), n.occurs(n.boolean(), n.zeroOrOne()), n.occurs(n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.zeroOrOne()), n.occurs(n.string(), n.zeroOrOne())), n.item()), ((...a) => {
	...
	return n.forEach(n.boolean($removeOp), test => {
		if (test) {
			let $o = a.pop($o);
			return map.map(n.pair("d", $d), n.pair("o", n.forEach(n.exists($newOp), test => {
				if (test) {
...
xqc.binOp$9 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	...
	let $left = /*      if($v eq 1901 and $has-op and $ocur("v") eq 1901) then*/ /*          []*/ /*      else */ n.forEach(n.boolean($precedingOp), test => {
		if (test) {
...
xqc.processOpen$6 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	...
	return n.forEach(n.eq($v, 2001), test => {
		if (test) {
			...
			let $it = n.forEach(n.or(n.eq($size, "0"), n.seq(n.and(n.geq(xqc.guardedGet($ret, $size)("t"), n.seq(1, 3, 6)), n.eq($hasSelect, n.false())))), test => {
				if (test) {
					return 2004;
				} else {
					return 2001;
				...
				if (test) {
					...
					let $tpl = n.forEach(n.boolean($hasParams), test => {
						if (test) {
							...
							return a.foldLeftAt($p, n.seq($tpl, xqc.tpl(3, n.minus($d, 1), ","), $cur), n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
								let $pre = a[0];
								let $cur = a[1];
								let $i = a[2];
					...
					let $tpl = n.forEach(n.boolean($hasFunc), test => {
						if (test) {
							...
							return n.forEach(n.or(n.eq($size, "0"), n.geq(xqc.guardedGet($ret, $size)("t"), n.seq(1, 3))), test => {
								if (test) {
																																							...
																																							let $isOcc = n.forEach(n.geq($v, n.seq(802, 904, 2003)), test => {
																																								if (test) {
																																									return n.forEach(n.and(n.eq($ocur("t"), "1"), n.and(n.eq($ocur("v"), "1"), n.gt($osize, "1"))), test => {
																																										if (test) {
																																											let $oprev = xqc.guardedGet($o, n.minus($osize, 1));
		...
		if (test) { /*                let $nu := console:log(map {"auto-constr":$ocur,"i":$i}) return*/
			...
			let $tpl = n.forEach(n.and($hasOp, n.eq($ocur("v"), 2108)), test => {
				if (test) {
					...
					return n.forEach(n.matches($v, "^xs:"), test => {
						if (test) {
							let $hasTypesig = n.and($hasOp, n.geq($ocur("v"), n.seq(1200, 2400)));
							$hasTypesig = n.forEach(n.and(n.eq($hasTypesig, n.false()), n.and(n.eq($ocur("t"), "1"), n.eq($ocur("v"), "1"))), test => {
								if (test) {
									let $oprev = xqc.guardedGet($o, n.minus($osize, 1));
									return n.and(n.eq($oprev("t"), "4"), n.geq($oprev("v"), n.seq(1200, 2400)));
								} else {
							...
							return n.forEach(n.boolean($hasTypesig), test => {
								if (test) {
																		...
																		if (test) {
																			...
																			return n.forEach(n.eq($t, 12), test => {
																				if (test) {
																					...
																					return n.forEach(n.eq($t, 13), test => {
																						if (test) {
...
xqc.toBuffer$1 = n.typed(n.function(n.seq(n.string()), n.item()), ((...a) => {
	let $query = a[0];
	return n.xForEach(n.stringToCodepoints($query), n.codepointsToString(a[0]));
}));
...
xqc.analyzeChars$18 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	...
	let $encExpr = a[15];
	let $hasQuot = a[16];
	let $opencount = a[17]; /* if the type changes, flush the buffer */
	/* TODO:
	 * WS for XML
	...
	let $number = n.and(n.and(n.eq($var, n.false()), $zero), n.and(n.eq($type, 11), n.and(n.ne($oldType, 12), n.ne($oldType, 14))));
										...
										if (test) {
											...
											return n.forEach(n.eq($type, 10), test => {
												if (test) {
													...
													return n.forEach(n.and(n.ne($type, 505), n.and(n.ne($type, 2600), n.and(n.ne($type, 509), n.and(n.ne($type, "9"), n.and(n.ne($type, 11), n.and(n.ne($type, 12), n.and(n.ne($type, 14), n.ne($type, "0")))))))), test => {
	...
	let $nu = console.log(map.map(n.pair("type", $type), n.pair("old", $oldType), n.pair("tpl", $tpl), n.pair("flag", $flag), n.pair("attrval", $attrval), n.pair("comment", $comment), n.pair("char", $char), n.pair("string", $string), n.pair("zero", $zero), n.pair("number", $number), n.pair("was-num", $wasNumber), n.pair("var", $var), n.pair("was-var", $wasVar), n.pair("buf", $buffer), n.pair("emit", $emitBuffer)));
	$ret = n.seq($ret, $tpl, n.forEach(n.eq($flag, "2"), test => {
		if (test) {
			return map.map(n.pair("t", xqc.flagToExpr($flag)), n.pair("v", n.forEach(n.empty($emitBuffer), test => {
				if (test) {
					return "";
				} else {
					return $emitBuffer;
			...
			return n.forEach(n.geq($flag, n.seq(4, 6, 8, 9, 10)), test => {
				if (test) {
					return n.forEach(n.boolean($emitBuffer), test => {
						if (test) {
							return map.map(n.pair("t", xqc.flagToExpr($flag)), n.pair("v", n.forEach(n.eq($flag, "8"), test => {
								if (test) {
									return "2";
								} else {
									return $emitBuffer;

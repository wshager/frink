...
xqc.guardedGet$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function guardedGet$2(...$) {
	...
	return $("r", $(1)),
		...
		($("last", $("r").call($, $("size"))),
			...
			(map.map()) :
			(await n.when(n.and(n.eq($("last").call($, "t"), 9), n.gt($("size"), 0))) ?
...
xqc.unwrap$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function unwrap$2(...$) {
	...
	return $("cur", $(1)),
		...
		( /*            let $nu := console:log("stop")*/ $("tpl", await n.when(n.or($("hasX"), $("hasXass"))) ?
			...
			console.log("TPL",$("tpl")),
			$("o", await n.when(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or($("hasParam"), $("hasConstr")), n.seq(n.and($("hasAss"), n.ne(xqc.guardedGet($("r"), $("size")).call($, "t"), 3)))), $("isBody")), $("hasAf")), $("matching")), $("closeThen")), $("isXret")), $("isX")), $("hasTuple"))) ?
				(a.pop($("o"))) :
				($("o"))),
			console.log("O",$("o")),
...
xqc.inspectBuf = (...$) => {
	const $len = $.length;
	if ($len == 1) return n.fromPromise(xqc.inspectBuf$1.apply(null, $));
};
xqc.incr = (...$) => {
	const $len = $.length;

...
unknown = 14
 */
xqc.ncform = n.typed(n.item(),"\\p{L}\\p{N}\\-_");
xqc.ncname = n.typed(n.item(),n.concat("^[", xqc.ncform, "]"));
xqc.qform = n.typed(n.item(),n.concat("[", xqc.ncform, ":]+"));
xqc.qname = n.typed(n.item(),n.concat("^", xqc.qform, "(#\\p{N}+)?$"));
...
xqc.constructors = n.typed(n.map(n.integer(), n.string()), map.map(n.pair(2101, "l"), n.pair(2102, "a"), n.pair(2103, "c"), n.pair(2104, "d"), n.pair(2105, "e"), n.pair(2106, "q"), n.pair(2107, "m"), n.pair(2108, "s"), n.pair(2109, "p"), n.pair(2110, "x")));
xqc.occurrence = n.typed(n.map(n.integer(), n.string()),map.map(n.pair(2003, "zero-or-one"), n.pair(904, "zero-or-more"), n.pair(802, "one-or-more")));
xqc.types = n.typed(n.occurs(n.item(),n.zeroOrMore()),n.seq("anyAtomicType", "untypedAtomic", "dateTime", "dateTimeStamp", "date", "time", "duration", "yearMonthDuration", "dayTimeDuration", "float", "double", "decimal", "integer", "nonPositiveInteger", "negativeInteger", "long", "int", "short", "byte", "nonNegativeInteger", "unsignedLong", "unsignedInt", "unsignedShort", "unsignedByte", "positiveInteger", "gYearMonth", "gYear", "gMonthDay", "gDay", "gMonth", "string", "normalizedString", "token", "language", "NMTOKEN", "Name", "NCName", "ID", "IDREF", "ENTITY", "boolean", "base64Binary", "hexBinary", "anyURI", "QName", "NOTATION"));
...
xqc.operatorTrie = n.typed(n.item(),n.jsonDoc("../lib/operator-trie.json"));
/* TODO detect these functions and fix them... */
xqc.cxf0 = n.typed(n.occurs(n.item(),n.zeroOrMore()),n.seq("base-uri", "data", "document-uri", "has-children", "last", "local-name", "name", "namespace-uri", "nilled", "node-name", "normalize-space", "number", "path", "position", "root", "string", "string-length", "generate-id"));
xqc.cxf1 = n.typed(n.occurs(n.item(),n.zeroOrMore()),n.seq("element-with-id", "id", "idref", "lang"));
xqc.uriChars = n.typed(n.map(n.string(), n.string()),map.map(n.pair("%3E", ">"), n.pair("%3C", "<"), n.pair("%2C", ","), n.pair("%3A", ":")));
xqc.detectCxf$1 = n.typed(n.function(n.seq(n.item()), n.item()), ((...a) => {
	let $sub = a[0];
	return a.foldLeftAt($sub, array.array(), n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
		let $acc = a[0];
		let $x = a[1];
		let $at = a[2];
...
xqc.replaceDotless$3 = n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $r = a[0];
	let $offset = a[1];
	let $cxfs = a[2];
	return a.foldRightAt($cxfs, $r, n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
		let $r = a[0];
		let $cxf = a[1];
		let $at = a[2];
		let $nu = console.log($cxf);
...
xqc.isQname$1 = n.typed(n.function(n.seq(n.item()), n.item()), ((...a) => {
	let $b = a[0]; /*    every $s in $b satisfies matches($s,$xqc:qform)*/ /*    fold-left($b,true(),function($acc,$s) {*/ /*        $acc and matches($s,$xqc:qform)*/ /*    })*/
	return n.matches(n.stringJoin($b), xqc.qname);
}));
xqc.inspectBuf$1 = n.typed(n.function(n.seq(n.item()), n.item()), ((...a) => {
	let $s = a[0];
				...
				if (test) {
					return n.if(xqc.isQname($s), test => {
						if (test) {
							...
							return n.if(n.eq(n.xFilter($s, ((...a) => {
								return n.geq(n.position(a[0]), 1);
							})), "$"), test => {
								if (test) {
...
xqc.incr$1 = n.typed(n.function(n.seq(n.item()), n.item()), ((...a) => {
	let $a = a[0];
	return array.forEach($a, n.typed(n.function(n.seq(n.item()), n.item()), ((...a) => {
		let $entry = a[0];
		return map.put($entry, "d", n.add(map.get($entry, "d"), 1));
	})));
}));
xqc.tpl$3 = n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $t = a[0];
	let $d = a[1];
	let $v = a[2];
	return map.map(n.pair("t", $t), n.pair("d", $d), n.pair("v", $v));
}));
xqc.opName$1 = n.typed(n.function(n.seq(n.item()), n.item()), ((...a) => {
	let $v = a[0];
...
xqc.guardedGet$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), ((...a) => {
	let $r = a[0];
	let $size = a[1];
	let $last = $r($size);
...
xqc.unwrap$6 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $cur = a[0];
	let $r = a[1];
	let $d = a[2];
	let $o = a[3];
	let $i = a[4];
	let $p = a[5]; /* TODO cleanup (e.g. separate is-close and is-op), apply for all cases */
	...
	let $hasConstrType = n.eq($has, 2100 /* has-params means there's no type-sig to close */ );
	...
	let $closeThen = n.and(n.eq($type, 208), n.eq($has, 207 /*    let $nu := if($close-then) then console:log(("has-params: ",$has-param,", is-type: ",$has-typesig," has-else: ",$has eq 208)) else ()*/ /* else adds a closing bracket */ ));
	let $nu = console.log(map.map(n.pair("t", $t), n.pair("v", $v), n.pair("d", $d), n.pair("has", $has), n.pair("has-tuple", $hasTuple), n.pair("matching", $matching), n.pair("ocur", $ocur), n.pair("has-typesig", $hasTypesig) /*        "has-constr-type":$has-constr-type,*/ /*        "has-param":$has-param,*/ /*        "has-ass":$has-ass,*/ /*        "is-body":$is-body, */ , n.pair("pass", $pass) /*        "has-x":$has-x,*/ , n.pair("ret", $r)));
		...
		if (test) {
			...
			return n.if(n.and($matching, n.eq($has, 2001)), test => {
				if (test) {
					...
					let $cxfs = xqc.detectCxf($sub);
					let $nu = console.log($cxfs);
					let $flat = array.flatten(array.forEach($cxfs, n.typed(n.function(n.seq(n.item()), n.item()), ((...a) => {
						let $x = a[0];
						return $x("qname");
					}))));
	...
	return n.if(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.eq($osize, 0), $pass), $hasAss), $isBody), $isLetInElse), $hasTypesig), $hasParam), $hasAf), $matching), $closeThen), $isXret), $hasXret), $isX), $hasX), $hasXfor), $hasConstr), $hasTuple), n.eq($has, 11)), test => {
		if (test) { /*            let $nu := console:log("stop")*/
								...
								if (test) {
									...
									return n.if(n.eq($v, 222), test => {
										if (test) {
											...
											return a.foldLeftAt($p, $tpl, n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
												let $pre = a[0];
												let $cur = a[1];
												let $i = a[2];
			...
			let $o = n.if(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or($hasParam, $hasConstr), n.seq(n.and($hasAss, n.ne(xqc.guardedGet($r, $size)("t"), 3)))), $isBody), $hasAf), $matching), $closeThen), $isXret), $isX), $hasTuple), test => {
				if (test) {
					return a.pop($o);
				} else {
					return $o;
			...
			return map.map(n.pair("r", n.if(n.exists($tpl), test => {
				if (test) {
					return n.foldLeft($tpl, $r, array.append);
				} else {
					return $r;
				}
			})), n.pair("d", n.if(n.or(n.or(n.or($isBody, $hasXret), $hasConstr), n.seq(n.and($matching, n.eq($ov, 2001)))), test => {
				if (test) {
					return n.subtract($d, 2);
				} else {
			...
			})), n.pair("o", $o), n.pair("i", n.if(n.boolean($pass), test => {
				if (test) {
					return $i;
				} else {
					return map.put($i, $d, array.size($r));
				}
			})), n.pair("p", n.if(n.boolean($hasXret), test => {
				if (test) {
					return array.array();
				} else {
					return $p;
			...
			return xqc.unwrap($cur, $r, n.if(n.and($hasOp, n.seq(n.or(n.gt($ov, 3000), $hasConstrType))), test => {
				if (test) {
					return $d;
				} else {
					return n.subtract($d, 1);
...
xqc.rtp$5 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $r = a[0];
	let $d = a[1];
	let $o = a[2];
	let $i = a[3];
...
xqc.rtp$6 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $r = a[0];
	let $d = a[1];
	let $o = a[2];
	let $i = a[3];
...
xqc.rtp$7 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $r = a[0];
	let $d = a[1];
	let $o = a[2];
	let $i = a[3];
...
xqc.rtp$8 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $r = a[0];
	let $d = a[1];
	let $o = a[2];
	let $i = a[3];
...
xqc.rtp$9 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.integer(), n.array(n.occurs(n.item(), n.zeroOrMore())), n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.array(n.occurs(n.item(), n.zeroOrMore())), n.occurs(n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.zeroOrMore()), n.occurs(n.boolean(), n.zeroOrOne()), n.occurs(n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.zeroOrOne()), n.occurs(n.string(), n.zeroOrOne())), n.item()), ((...a) => {
	let $r = a[0];
	let $d = a[1];
	let $o = a[2];
	let $i = a[3];
	...
	let $newOp = a[7];
	let $param = a[8];
	return n.if(n.boolean($removeOp), test => {
		if (test) {
			let $o = a.pop($o);
			return map.map(n.pair("d", $d), n.pair("o", n.if(n.exists($newOp), test => {
				if (test) {
					return array.append($o, $newOp);
				} else {
					return $o;
				}
			})), n.pair("i", n.if(n.exists($tpl), test => {
				if (test) {
					return map.put($i, n.xFilter($tpl, ((...a) => {
						return n.geq(n.position(a[0]), 1);
					}))("d"), n.add(array.size($r), 1));
				} else {
					return $i;
				}
			})), n.pair("r", n.if(n.exists($tpl), test => {
				if (test) {
					return n.foldLeft($tpl, $r, array.append);
				} else {
					return $r;
				}
			})), n.pair("p", n.if(n.boolean($param), test => {
				if (test) {
...
xqc.binOp$9 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $t = a[1];
	let $v = a[2];
	let $d = a[3];
	...
	let $p = a[6];
	let $ocur = a[7];
	let $hasPreOp = a[8]; /* preceding means the current operator has lower precedence (default is higher)... */ /* we make an exception when current is filter and preceding is select */
	...
	let $nu = console.log(n.seq("bin-op: ", $v, ", ocur: ", $ocur, ", prec: ", $precedingOp, ", d: ", $d, ", i: ", $i)) /* if preceding, lower depth, as to take the previous index */ /* furthermore, close directly and remove the operator */ ;
	...
	let $split = n.if(map.contains($i, $d), test => {
		if (test) {
			return $i($d);
		} else {
			return 1; /*  let $nu := console:log($split)*/ /*  let $split := if($ret($split)("t") eq 1) then $split - 1 else $split*/
		}
	});
	let $left = /*      if($v eq 1901 and $has-op and $ocur("v") eq 1901) then*/ /*          []*/ /*      else */ n.if(n.boolean($precedingOp), test => {
		if (test) {
	...
	$ret = array.append(array.subarray($ret, 1, n.subtract($split, 1)), xqc.tpl(4, $d, xqc.opName($v)));
	$i = n.if(n.boolean($precedingOp), test => {
		if (test) {
			return map.put($i, $d, $split);
		} else {
			return map.put($i, $d, array.size($ret)); /* up depth by 1 to leave $i updated */
		}
	});
...
xqc.processOpen$6 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $v = a[1];
	let $d = a[2];
	let $o = a[3];
	...
	return n.if(n.eq($v, 2001), test => {
		if (test) {
			...
			let $it = n.if(n.or(n.eq($size, 0), n.seq(n.and(n.geq(xqc.guardedGet($ret, $size)("t"), n.seq(1, 3, 6)), n.eq($hasSelect, n.false())))), test => {
				if (test) {
					return 2004;
				} else {
					return 2001;
			...
			return n.if(n.eq($v, 3), test => {
				if (test) {
					...
					let $hasParams = n.and($hasOp, n.eq($ocur("v"), 3106 /* don't treat function as constructor here */ ));
					...
					let $tpl = n.if(n.boolean($hasParams), test => {
						if (test) {
							let $tpl = n.if(n.boolean($hasRettype), test => {
								if (test) {
									return xqc.tpl(2, $d, 2);
								} else {
							...
							return a.foldLeftAt($p, n.seq($tpl, xqc.tpl(3, n.subtract($d, 1), ","), $cur), n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
								let $pre = a[0];
								let $cur = a[1];
								let $i = a[2];
					...
					return xqc.rtp($ret, n.if(n.boolean($hasParams), test => {
						if (test) {
							return $d;
						} else {
							return n.add($d, 1);
					...
					let $last = n.if(n.boolean($size), test => {
						if (test) {
							return xqc.guardedGet($ret, $size);
						} else {
							return map.map();
						}
					});
					let $hasLambda = n.and($hasFunc, n.eq($last("t"), 4));
					let $ret = n.if(n.boolean($hasLambda), test => {
						if (test) {
							return a.pop($ret);
						} else {
							return $ret;
					...
					let $tpl = n.if(n.boolean($hasFunc), test => {
						if (test) {
							...
							return n.if(n.or(n.eq($size, 0), n.geq(xqc.guardedGet($ret, $size)("t"), n.seq(1, 3))), test => {
								if (test) {
					...
					return xqc.rtp($ret, n.if(n.boolean($hasFunc), test => {
						if (test) {
							return n.add($d, 2);
						} else {
							return n.add($d, 1);
...
xqc.processComma$6 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $v = a[1];
	let $d = a[2];
	let $o = a[3];
	...
	return n.if(n.or(n.seq(n.and($hasOp, n.eq($ocur("v"), 3006))), n.seq(n.and(n.eq($ocur("t"), 1), n.eq($ocur("v"), 2004)))), test => {
		if (test) {
			...
			return xqc.rtp($tmp("r"), n.if(n.boolean($hasAss), test => {
				if (test) {
					return n.add($d, 1);
				} else {
					return $d;
...
xqc.processOp$6 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $v = a[1];
	let $d = a[2];
	let $o = a[3];
											...
											return n.if(n.eq($v, 219), test => {
												if (test) {
													...
													return n.if(n.eq($v, 2106), test => {
														if (test) { /* check if o contains declare, otherwise it's anonymous */
															...
															return n.if(n.eq($v, 2400), test => {
																if (test) {
																	...
																	return xqc.rtp($ret, $d, $o, $i, $p, n.if(n.boolean($hasParams), test => {
																		if (test) {
																			return n.seq();
																		} else {
																			return xqc.tpl(3, $d, ",");
																		...
																		if (test) {
																			...
																			return n.if(n.eq($v, 208), test => {
																				if (test) {
																					...
																					let $d = $tmp("d");
																					return xqc.rtp($tmp("r"), $d, $tmp("o"), $tmp("i"), $tmp("p"), n.seq(xqc.tpl(2, $d, 4), xqc.tpl(3, n.subtract($d, 1), ","), xqc.tpl(1, n.subtract($d, 1), 3)), n.false(), xqc.tpl($t, $d, $v));
																				} else {
																					return n.if(n.eq($v, 209), test => {
																						if (test) { /* TODO check if o contains something that prevents creating a new let-ret-seq */ /* remove entry */
																							...
																							return xqc.rtp($tmp("r"), n.add($d, 2), $o, $tmp("i"), $tmp("p"), n.if(n.boolean($hasX), test => {
																								if (test) {
																									return n.seq();
																								} else {
																																				...
																																				if (test) {
																																					return n.if(n.eq($size, 0), test => {
																																						if (test) { /* unary-op: insert op + parens */
																																							...
																																							let $prev = xqc.guardedGet($ret, $size);
																																							...
																																							return n.if(n.boolean($isOcc), test => {
																																								if (test) { /* these operators are occurrence indicators when the previous is an open paren or qname */ /* when the previous is a closed paren, it depends what the next will be */ /*                                if($has-op) then*/
																																									let $split = $i($d);
																																									let $left = array.subarray($ret, 1, n.subtract($split, 1));
																																									let $right = array.subarray($ret, $split);
																																									return xqc.rtp($left, $d, $o, $i, $p, n.seq(xqc.tpl($t, $d, "occurs"), xqc.tpl(1, $d, 1), array.flatten(xqc.incr($right)), xqc.tpl(3, $d, ","), xqc.tpl($t, n.add($d, 1), xqc.occurrence($v)), xqc.tpl(1, n.add($d, 1), 1), xqc.tpl(2, n.add($d, 1), 2), xqc.tpl(2, $d, 2))); /*                                else*/ /*                                    xqc:rtp($ret,$d,$o,$i,$p,xqc:tpl(7,$d,$xqc:operators($v)))*/
																																								} else {
...
xqc.processVar$6 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $v = a[1];
	let $d = a[2];
	let $o = a[3];
	...
	$v = n.replace($v, "^\\$", "");
	let $tpl = n.if(n.or(n.or($isParam, $hasXass), $hasX), test => {
		if (test) {
			return n.seq();
		} else {
			return n.if(n.boolean($hasAss), test => {
	...
	return xqc.rtp($ret, $d, $o, $i, $p, $tpl, n.seq(), n.seq(), n.if(n.or(n.or($isParam, $hasXass), $hasX), test => {
		if (test) {
			return $v;
		} else {
			return n.seq();
...
xqc.processQname$6 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $v = a[1];
	let $d = a[2];
	let $o = a[3];
				...
				if (test) {
					...
					return n.if(n.matches($v, "^xs:"), test => {
						if (test) {
							...
							$hasTypesig = n.if(n.and(n.eq($hasTypesig, n.false()), n.and(n.eq($ocur("t"), 1), n.eq($ocur("v"), 1))), test => {
								if (test) {
									let $oprev = xqc.guardedGet($o, n.subtract($osize, 1));
									return n.and(n.eq($oprev("t"), 4), n.geq($oprev("v"), n.seq(1200, 2400)));
								} else {
 ...
 */
xqc.process$6 = n.typed(n.function(n.seq(n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.array(n.occurs(n.item(), n.zeroOrMore())), n.integer(), n.array(n.occurs(n.item(), n.zeroOrMore())), n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.array(n.occurs(n.item(), n.zeroOrMore()))), n.item()), ((...a) => {
	let $cur = a[0];
	let $ret = a[1];
	let $d = a[2];
	let $o = a[3];
	...
	return n.if(n.eq($t, 0), test => {
		if (test) {
			...
			return n.if(n.eq($t, 1), test => {
				if (test) {
					return xqc.processOpen($ret, $v, $d, $o, $i, $p);
				} else {
					return n.if(n.eq($t, 2), test => {
						if (test) {
							return xqc.unwrap(xqc.tpl($t, $d, $v), $ret, $d, $o, $i, $p);
							...
							return n.if(n.eq($t, 3), test => {
								if (test) {
									return xqc.processComma($ret, $v, $d, $o, $i, $p);
								} else {
									return n.if(n.eq($t, 4), test => {
										if (test) {
											return xqc.processOp($ret, $v, $d, $o, $i, $p);
										} else {
											return n.if(n.eq($t, 5), test => {
												if (test) {
													return xqc.processVar($ret, $v, $d, $o, $i, $p);
												} else {
													return n.if(n.eq($t, 6), test => {
														if (test) {
															return xqc.processQname($ret, $v, $d, $o, $i, $p);
														} else {
...
xqc.wrapDepth$7 = n.typed(n.function(n.seq(n.occurs(n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.zeroOrMore()), n.array(n.occurs(n.item(), n.zeroOrMore())), n.integer(), n.array(n.occurs(n.item(), n.zeroOrMore())), n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.array(n.occurs(n.item(), n.zeroOrMore())), n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore()))), n.item()), ((...a) => {
	let $parts = a[0];
	let $ret = a[1];
	let $depth = a[2];
	let $o = a[3];
	...
	let $p = a[5];
	let $params = a[6];
	return n.if(n.empty($parts), test => {
		if (test) {
			return n.if(n.ne($ret(array.size($ret))("t"), 0), test => {
				if (test) {
					return xqc.unwrap(map.map(n.pair("t", 0)), $ret, $depth, $o, $i, $p)("r");
				} else {
					return $ret;
				}
			});
		} else {
			let $out = n.if(n.exists($parts), test => {
				if (test) {
					return n.head($parts);
				} else {
					return n.seq();
			...
			let $tmp = n.foldLeft($out, map.map(n.pair("r", $ret), n.pair("d", $depth), n.pair("o", $o), n.pair("i", $i), n.pair("p", $p)), n.typed(n.function(n.seq(n.item(), n.item()), n.item()), ((...a) => {
				let $pre = a[0];
				let $cur = a[1];
				return n.if(n.exists($cur), test => {
					if (test) {
						let $tmp = xqc.process($cur, $pre("r"), $pre("d"), $pre("o"), $pre("i"), $pre("p")) /*                let $nu := console:log($tmp("r"))*/ ;
						return $tmp;
					} else {
						return $pre;
					}
...
xqc.toL3$5 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $pre = a[0];
	let $entry = a[1];
	let $at = a[2];
	let $normalform = a[3];
	...
	let $s = n.if(n.geq($t, 1), test => {
		if (test) {
				...
				if (test) {
					...
					return n.if(n.eq($v, 1), test => {
						if (test) { /* TODO check for last operator */
							let $last = n.if(n.gt($at, 1), test => {
								if (test) {
									return $normalform(n.subtract($at, 1));
								} else {
									return n.seq();
								}
							});
							return n.if(n.and(n.exists($last), n.geq($last("t"), n.seq(4, 6, 10))), test => {
								if (test) {
									return n.seq();
								} else {
									return n.if(n.and(n.exists($last), n.eq($last("t"), 2)), test => {
										if (test) {
											return n.seq();
										} else {
											return n.seq(14, "");
			...
			return n.if(n.eq($t, 2), test => {
				if (test) {
					let $next = n.if(n.lt($at, $size), test => {
						if (test) {
							return $normalform(n.add($at, 1));
						} else {
							return n.seq(); /*            let $nu := console:log($next)*/
						}
					});
					return n.if(n.and(n.exists($next), n.eq($next("t"), 1)), test => {
						if (test) {
							return 18;
						} else {
							return 17;
...
xqc.toBuffer$1 = n.typed(n.function(n.seq(n.string()), n.item()), ((...a) => {
	let $query = a[0];
	return n.xForEach(n.stringToCodepoints($query), (...a) => n.codepointsToString(a[0]),"toBuffer");
}));
xqc.normalizeQuery$2 = n.typed(n.function(n.seq(n.string(), n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore()))), n.item()), ((...a) => {
	let $query = a[0];
	let $params = a[1]; /* FIXME properly handle cases in replace below */
...
xqc.normalizeQueryB$2 = n.typed(n.function(n.seq(n.occurs(n.string(), n.zeroOrMore()), n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore()))), n.item()), ((...a) => {
	let $buffer = a[0];
	let $params = a[1]; /* TODO strip comments for now */
	let $preparedBuffer = xqc.analyzeChars($buffer, n.eq($params("$compat"), "xquery")) /*    let $nu := console:log($prepared-buffer)*/ ;
	let $normalform = xqc.wrapDepth($preparedBuffer, array.array(), 1, array.array(), map.map(), array.array(), $params);
	let $output = $params("$transpile");
	return n.if(n.eq($output, "rdl"), test => {
		if (test) {
			return a.foldLeft($normalform, "", n.typed(n.function(n.seq(n.item(), n.item()), n.item()), ((...a) => {
				let $pre = a[0];
				let $entry = a[1];
				let $t = $entry("t");
				let $v = $entry("v");
			...
			return n.if(n.eq($output, "l3"), test => {
				if (test) {
					return a.foldLeftAt($normalform, n.seq(), n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
						let $pre = a[0];
						let $entry = a[1];
						let $at = a[2];
...
*/
/* blocking chars */
xqc.analyzeChar$1 = n.typed(n.function(n.seq(n.item()), n.item()), ((...a) => {
	let $char = a[0];
...
xqc.flagToExpr$1 = n.typed(n.function(n.seq(n.item()), n.item()), ((...a) => {
	let $flag = a[0];
...
xqc.inspectTokens$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), ((...a) => {
	let $char = a[0];
	let $type = a[1];
...
xqc.analyzeChars$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), ((...a) => {
	let $chars = a[0];
	let $xqCompat = a[1];
...
xqc.analyzeChars$18 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	/* TODO:
	 * WS for XML
	...
	return (
		...
		$encExpr = a[15],
		$hasQuot = a[16],
		$opencount = a[17], /* if the type changes, flush the buffer */
		//console.log($char),
		$next = n.head($chars),
		$stop = n.empty($chars),
		...
		$fixQuot = n.and(n.exists($tpl), n.and(n.eq($tpl("t"), 7), n.eq($type, 6))),
		//$tpl.subscribe(),
		...
		$string = n.if(n.or($fixQuotAnd, $attrval), (($string,test) => {
			if (test) {
				return $type;
			} else {
		...
		$oldType = n.if(n.eq($type, 10), (($oldType,test) => {
			if (test) {
				return $oldType;
			} else {
				return $type;
		...
		n.if(n.boolean($stop), (($chars,test) => {
			if (test) {
				return $ret;
			} else {
				let $rest = n.tail($chars);
				return xqc.analyzeChars($ret, $rest, $xqCompat, $next, $oldType, n.if(n.or(n.or($emitBuffer, $attrval), n.geq($flag, n.seq(2, 6, 9))), test => {
				...
				}), $string, $var, $wasQname, $number, n.if(n.eq($flag, 3), test => {
					if (test) {
						return n.true();
					} else {
						return n.if(n.eq($flag, 4), test => {
				...
				}), $hasQuot, n.if(n.eq($flag, 11), test => {
					if (test) {
		...
		}).bind(null,$chars)).observeOn(null)
	);
}));
xqc.detectCxf = (...a) => {
	const len = a.length;
	if (len == 1) return xqc.detectCxf$1.apply(null, a);
};
xqc.replaceDotless = (...a) => {
	const len = a.length;
	if (len == 3) return xqc.replaceDotless$3.apply(null, a);
};
xqc.isQname = (...a) => {
	const len = a.length;
	if (len == 1) return xqc.isQname$1.apply(null, a);
};
xqc.inspectBuf = (...a) => {
	const len = a.length;
	if (len == 1) return xqc.inspectBuf$1.apply(null, a);
};
xqc.incr = (...a) => {
	const len = a.length;
	if (len == 1) return xqc.incr$1.apply(null, a);
};
xqc.tpl = (...a) => {
	const len = a.length;
	if (len == 3) return xqc.tpl$3.apply(null, a);
};
xqc.opName = (...a) => {
	const len = a.length;
	if (len == 1) return xqc.opName$1.apply(null, a);
};
xqc.guardedGet = (...a) => {
	const len = a.length;
	if (len == 2) return xqc.guardedGet$2.apply(null, a);
};
xqc.unwrap = (...a) => {
	const len = a.length;
	if (len == 6) return xqc.unwrap$6.apply(null, a);
};
xqc.rtp = (...a) => {
	const len = a.length;
	if (len == 5) return xqc.rtp$5.apply(null, a);
	if (len == 6) return xqc.rtp$6.apply(null, a);
	if (len == 7) return xqc.rtp$7.apply(null, a);
	if (len == 8) return xqc.rtp$8.apply(null, a);
	if (len == 9) return xqc.rtp$9.apply(null, a);
};
xqc.binOp = (...a) => {
	const len = a.length;
	if (len == 9) return xqc.binOp$9.apply(null, a);
};
xqc.processOpen = (...a) => {
	const len = a.length;
	if (len == 6) return xqc.processOpen$6.apply(null, a);
};
xqc.processComma = (...a) => {
	const len = a.length;
	if (len == 6) return xqc.processComma$6.apply(null, a);
};
xqc.processOp = (...a) => {
	const len = a.length;
	if (len == 6) return xqc.processOp$6.apply(null, a);
};
xqc.processVar = (...a) => {
	const len = a.length;
	if (len == 6) return xqc.processVar$6.apply(null, a);
};
xqc.processQname = (...a) => {
	const len = a.length;
	if (len == 6) return xqc.processQname$6.apply(null, a);
};
xqc.process = (...a) => {
	const len = a.length;
	if (len == 6) return xqc.process$6.apply(null, a);
};
xqc.wrapDepth = (...a) => {
	const len = a.length;
	if (len == 7) return xqc.wrapDepth$7.apply(null, a);
};
xqc.toL3 = (...a) => {
	const len = a.length;
	if (len == 5) return xqc.toL3$5.apply(null, a);
};
xqc.toBuffer = (...a) => {
	const len = a.length;
	if (len == 1) return xqc.toBuffer$1.apply(null, a);
};
xqc.normalizeQuery = (...a) => {
	const len = a.length;
	if (len == 2) return xqc.normalizeQuery$2.apply(null, a);
};
xqc.normalizeQueryB = (...a) => {
	const len = a.length;
	if (len == 2) return xqc.normalizeQueryB$2.apply(null, a);
};
xqc.analyzeChar = (...a) => {
	const len = a.length;
	if (len == 1) return xqc.analyzeChar$1.apply(null, a);
};
xqc.flagToExpr = (...a) => {
	const len = a.length;
	if (len == 1) return xqc.flagToExpr$1.apply(null, a);
};
xqc.inspectTokens = (...a) => {
	const len = a.length;
	if (len == 2) return xqc.inspectTokens$2.apply(null, a);
};
xqc.analyzeChars = (...a) => {
	const len = a.length;
	if (len == 2) return xqc.analyzeChars$2.apply(null, a);
	if (len == 18) return xqc.analyzeChars$18.apply(null, a);
};
module.exports = xqc;

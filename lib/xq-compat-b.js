...
xqc.detectCxf$1 = n.typed(n.function(n.seq(n.item()), n.item()), (async function detectCxf$1(...$) {
	$ = n.frame($);
	return $("sub", $(1)),
		a.foldLeftAt($("sub"), array.array(), n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), (async function(...$) {
			...
			return $("acc", $(1)),
				$("x", $(2)),
				$("at", $(3)),
				await n.when(n.and(n.eq($("x").call($, "t"), 6), n.geq($("x").call($, "v"), (xqc.cxf0)))) ?
...
xqc.inspectBuf$1 = n.typed(n.function(n.seq(n.item()), n.item()), (async function inspectBuf$1(...$) {
	$ = n.frame($);
	return $("s", $(1)),
		await n.when(n.empty($("s"))) ?
		(n.seq()) :
		($("ret", dawg.traverse((xqc.operatorTrie), $("s"))),
			await n.when(n.or(n.empty($("ret")), n.instanceOf($("ret"), n.array(n.occurs(n.item(), n.zeroOrMore()))))) ?
...
xqc.tpl$3 = n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), (async function tpl$3(...$) {
	$ = n.frame($);
	return $("t", $(1)),
		$("d", $(2)),
		$("v", $(3)),
...
xqc.guardedGet$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function guardedGet$2(...$) {
	$ = n.frame($);
	return $("r", $(1)),
		$("size", $(2)),
		await n.when(n.gt($("size"), 0)) ?
		(console.log("true-size-0"),$("last", $("r").call($, $("size"))),
			//console.log("GG-LAST",$("last")),
			await n.when(n.empty($("last"))) ?
			(console.log("true-empty-last"),map.map()) :
			(console.log("false-empty-last"),await n.when(n.and(n.eq($("last").call($, "t"), 9), n.gt($("size"), 0))) ?
				(console.log("true-last-t-9"),xqc.guardedGet($("r"), n.subtract($("size"), 1))) :
				(console.log("false-last-t-9"),$("last")))) :
		(console.log("false-size-0"),map.map())
}));
xqc.unwrap$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function unwrap$2(...$) {
	$ = n.frame($);
	return $("cur", $(1)),
		$("tmp", $(2)),
		$("r", $("tmp").call($, "r")),
				...
				(await n.when(n.boolean($("hasOp"))) ?
					(await n.when(n.eq($("ov"), 210)) ?
						(await n.when(n.geq($("type"), n.seq(209, 211))) ?
							($("ov")) :
							(n.seq())) :
						(await n.when(n.and(n.gt($("ov"), 2100), n.lt($("ov"), 2200))) ?
							(2100) :
							(await n.when(n.and(n.eq($("type"), 4), n.seq(n.and(n.gt($("ov"), 3000), n.lt($("ov"), 3100))))) ?
								(2200 /* some constructor */ ) :
								(await n.when(n.and(n.seq(n.or(n.eq($("type"), 2), n.eq($("t"), 3))), n.eq($("ov"), 3006))) ?
									(3006 /* params */ ) :
									(await n.when(n.and(n.eq($("type"), 6), n.geq($("ov"), n.seq(2001, 2004)))) ?
										(4000 /* array / filter */ ) :
		...
		$("hasAf", n.eq($("has"), 4000)),
		console.log("o",$("o")),
		$("hasXass", n.and($("hasOp"), n.and(n.eq($("ov"), 210), n.seq(n.or($("isX"), n.seq(n.and($("hasAss"), n.and(n.gt($("osize"), 1), n.and(n.eq($("o").call($, n.subtract($("osize"), 1)).call($, "t"), 4), n.geq($("o").call($, n.subtract($("osize"), 1)).call($, "v"), n.seq(222, 223, 224, 225))))))))))),		$("isXret", n.and(n.eq($("type"), 211), n.seq(n.or($("hasX"), $("hasXass"))) /* just some operators to close */ )),
		...
		console.log("has",$("has")),
		$("isLetInElse", n.fromPromise(await n.when(n.eq($("has"), 208)) &&
		 	await n.when(n.eq($("isLet"), n.true())) && await n.when(n.eq(xqc.guardedGet($("r"), $("size")).call($, "t"), 1)))),
		$("r", await n.when(n.and(n.eq($("has"), 208), n.eq($("isLetInElse"), n.false()))) ?
			(array.append($("r"), xqc.tpl(2, $("d"), 4))) :
			(await n.when(n.and($("matching"), n.eq($("has"), 2001))) ?
				($("index", $("i").call($, $("d"))),
				...
				($("r")))),
		$("d", await n.when(n.and(n.eq($("has"), 208), $("isLetInElse"))) ?
			(n.subtract($("d"), 1)) :
			($("d"))),
		await n.when(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.eq($("osize"), 0), $("pass")), $("hasAss")), $("isBody")), $("isLetInElse")), $("hasTypesig")), $("hasParam")), $("hasAf")), $("matching")), $("closeThen")), $("isXret")), $("hasXret")), $("isX")), $("hasX")), $("hasXfor")), $("hasConstr")), $("hasTuple")), n.eq($("has"), 11))) ?
		( /*            let $nu := console:log("stop")*/ $("tpl", await n.when(n.or($("hasX"), $("hasXass"))) ?
				(n.seq(xqc.tpl(1, $("d"), 4), xqc.tpl(2, n.subtract($("d"), 1), 2), xqc.tpl(3, n.subtract($("d"), 2), ","))) :
				(n.seq())),
			$("d", await n.when(n.or($("hasX"), $("hasXass"))) ?
				(n.subtract($("d"), 2)) :
				($("d"))),
			$("tpl", await n.when(n.boolean($("hasTuple"))) ?
				...
				(await n.when(n.boolean($("hasParam"))) ?
					...
					(await n.when(n.or(n.or($("isXret"), $("isX")), $("isXlet"))) ?
						($("tpl", n.seq($("tpl"), xqc.tpl(4, $("d"), (xqc.operators).call($, $("v"))), xqc.tpl(1, $("d"), 1), xqc.tpl(1, $("d"), 1, 3))),
							...
							(a.foldLeftAt($("p"), $("tpl"), n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), (async function(...$) {
								...
								return $("pre", $(1)),
									$("cur", $(2)),
									$("i", $(3)),
									n.seq($("pre"), xqc.tpl(10, $("d"), "$"), xqc.tpl(1, $("d"), 1), xqc.tpl(4, $("d"), 1, $("cur")), xqc.tpl(3, $("d"), 1, ","), xqc.tpl(4, $("d"), 1, "$"), xqc.tpl(1, $("d"), 1, 1), xqc.tpl(8, $("d"), 2, $("i")), xqc.tpl(2, $("d"), 1, 2), xqc.tpl(2, $("d"), 2), await n.when(n.or($("isLet"), n.eq($("type"), 225))) ?
										(n.seq()) :
										(xqc.tpl(3, $("d"), ",")))
							}))))) :
						(await n.when(n.boolean($("hasXret"))) ?
							(n.seq(xqc.tpl(2, $("d"), 4), xqc.tpl(2, n.subtract($("d"), 1), 2), xqc.tpl(2, n.subtract($("d"), 2), 2))) :
							(await n.when(n.and($("isX"), $("hasX"))) ?
								(n.seq($("tpl"), xqc.tpl(3, $("d"), ","))) :
								(await n.when(n.and($("matching"), n.eq($("ov"), 2001))) ?
									( /* TODO detect context-functions */ n.seq(xqc.tpl($("t"), $("d"), 4), xqc.tpl($("t"), n.subtract($("d"), 1), 2))) :
									(await n.when(n.or($("isBody"), $("hasConstr"))) ?
										(n.seq(xqc.tpl($("t"), $("d"), $("v")), xqc.tpl($("t"), n.subtract($("d"), 1), 2))) :
										(await n.when(n.or($("hasAf"), $("isClose"))) ?
											($("closeCurly", await n.when(n.eq($("has"), 3)) ?
												...
												xqc.tpl($("t"), $("d"), await n.when(n.boolean($("closeCurly"))) ?
													($("v")) :
													(2))) :
											(await n.when(n.or(n.or($("pass"), $("closeThen")), $("hasXfor"))) ?
												(n.seq()) :
												(await n.when(n.boolean($("hasAss"))) ?
													(await n.when(n.and($("isLet"), n.eq(xqc.guardedGet($("r"), $("size")).call($, "t"), 3))) ?
														(n.seq()) :
			...
			console.log("R",$("r").call($,$("size")).call($,"t")),
			$("o", await n.when(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(
				$("hasParam"), $("hasConstr")), n.seq(n.and($("hasAss"), n.ne(xqc.guardedGet($("r"), $("size")).call($, "t"), 3)))), $("isBody")), $("hasAf")), $("matching")), $("closeThen")), $("isXret")), $("isX")), $("hasTuple"))) ?
				(a.pop($("o"))) :
				($("o"))),
			//console.log("O",$("o")),
			$("o", await n.when(n.boolean($("closeParams"))) ?
				(array.append($("o"), xqc.tpl(4, $("d"), 3106))) :
				(await n.when(n.or($("isXret"), $("isX"))) ?
					(array.append($("o"), xqc.tpl($("t"), $("d"), $("v")))) :
					($("o")))),
			$("tmp", map.put($("tmp"), "r", await n.when(n.exists($("tpl"))) ?
				(n.foldLeft($("tpl"), $("r"), array.append)) :
				($("r")))),
			$("tmp", map.put($("tmp"), "d", await n.when(n.or(n.or(n.or($("isBody"), $("hasXret")), $("hasConstr")), n.seq(n.and($("matching"), n.eq($("ov"), 2001))))) ?
				(n.subtract($("d"), 2)) :
				(await n.when(n.boolean($("isXret"))) ?
					(n.add($("d"), 1)) :
					(await n.when(n.or($("isX"), $("isXlet"))) ?
						(n.add($("d"), 2)) :
						(await n.when(n.or(n.or(n.or(n.or($("hasAss"), $("hasParam")), $("hasAf")), $("matching")), $("hasTuple"))) ?
							(n.subtract($("d"), 1)) :
							($("d"))))))),
			$("tmp", map.put($("tmp"), "o", $("o"))),
			...
			map.put($("tmp"), "p", await n.when(n.boolean($("hasXret"))) ?
				(array.array()) :
				($("p")))) :
		( /*            let $nu := console:log("auto")*/ $("r", await n.when(n.and($("hasOp"), n.seq(n.or(n.gt($("ov"), 3000), $("hasConstrType"))))) ?
				($("r")) :
				(array.append($("r"), xqc.tpl(2, $("d"), 2)))),
			$("tmp", map.put($("tmp"), "r", $("r"))),
			console.log("auto",$("tmp")),
			$("tmp", map.put($("tmp"), "d", await n.when(n.and($("hasOp"), n.seq(n.or(n.gt($("ov"), 3000), $("hasConstrType"))))) ?
				($("d")) :
				(n.subtract($("d"), 1)))),
...
xqc.binOp$5 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("t", $(1)),
		...
		$("precedingOp", await n.when(n.and($("hasPreOp"), $("ocur").call($, "v"))) ?
			(await n.when(n.and(n.eq($("ocur").call($, "v"), 1901), n.eq($("v"), 2001))) ?
				(n.true()) :
				(n.ge($("ocur").call($, "v"), $("v")))) :
...
xqc.processOpen$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("v", $(1)),
		...
		($("cur", xqc.tpl($("t"), $("d"), $("v")) /* TODO pull in right-side if filter, except when select */ ),
			...
			$("it", await n.when(n.or(n.eq($("size"), 0), n.seq(n.and(n.geq(xqc.guardedGet($("r"), $("size")).call($, "t"), n.seq(1, 3, 6)), n.eq($("hasSelect"), n.false()))))) ?
				(2004) :
				(2001)),
			...
			($("hasRettype", n.and($("hasOp"), n.geq($("ocur").call($, "v"), 2400))),
					...
					($("tpl", await n.when(n.boolean($("hasRettype"))) ?
						...
						a.foldLeftAt($("p"), n.seq($("tpl"), xqc.tpl(3, n.subtract($("d"), 1), ","), $("cur")), n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), (async function(...$) {
							...
							return $("pre", $(1)),
								$("cur", $(2)),
								$("i", $(3)),
								n.seq($("pre"), xqc.tpl(10, $("d"), "$"), xqc.tpl(1, $("d"), 1), xqc.tpl(5, $("d"), 1, $("cur")), xqc.tpl(3, $("d"), 1, ","), xqc.tpl(10, $("d"), 1, "$"), xqc.tpl(1, $("d"), 1), xqc.tpl(8, $("d"), n.string($("i"))), xqc.tpl(2, $("d"), 2), xqc.tpl(2, $("d"), 2), xqc.tpl(3, $("d"), ","))
						})))) :
				...
				xqc.rtp($("tmp"), $("r"), await n.when(n.boolean($("hasParams"))) ?
					...
					(await n.when(n.boolean($("hasConstrType"))) ?
						($("ocur")) :
						($("cur"))))) :
			( /* detect first opening bracket after function declaration */ /* detect parameters, we need to change 2106 to something else at opening bracket here */ $("hasFunc", n.and($("hasOp"), n.eq($("ocur").call($, "v"), 2106))),
				...
				$("tpl", await n.when(n.boolean($("hasFunc"))) ?
					...
					(await n.when(n.or(n.eq($("size"), 0), n.geq($("last").call($, "t"), n.seq(1, 3)))) ?
						(n.seq(xqc.tpl(4, $("d"), ""), $("cur"))) :
						($("cur")))),
				/* remove constr type if not constr */
				xqc.rtp($("tmp"), $("r"), await n.when(n.boolean($("hasFunc"))) ?
					(n.add($("d"), 2)) :
					(n.add($("d"), 1)), $("o"), $("i"), $("p"), $("tpl"), n.or($("hasFunc"), $("hasConstrType")), await n.when(n.boolean($("hasFunc"))) ?
					(xqc.tpl(4, $("d"), 3006)) :
					($("cur")))))
}));
xqc.processComma$1 = n.typed(n.function(n.seq(n.item()), n.item()), (async function(...$) {
	...
	return $("tmp", $(1)),
		...
		$("ocur", await n.when(n.gt($("osize"), 0)) ?
			...
			(map.map())),
		$("hasOp", n.eq($("ocur").call($, "t"), 4)),
		await n.when(n.or(n.seq(n.and($("hasOp"), n.eq($("ocur").call($, "v"), 3006))), n.seq(n.and(n.eq($("ocur").call($, "t"), 1), n.eq($("ocur").call($, "v"), 2004))))) ?
		($("cur", xqc.tpl($("t"), $("d"), $("v"))),
		...
		($("cur", xqc.tpl($("t"), $("d"), $("v"))),
			...
			$("tpl", await n.when(n.boolean($("hasAss"))) ?
				...
				(await n.when(n.or($("hasTypesig"), n.seq(n.and($("hasOp"), n.geq($("ocur").call($, "v"), n.seq(210, 700)))))) ?
					(n.seq()) :
					(xqc.tpl($("t"), $("d"), $("v"))))),
...
xqc.processOp$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("v", $(1)),
		...
		(await n.when(n.eq($("v"), 218)) ?
			( /* TODO check if o contains declare (would it not?) */ xqc.rtp($("tmp"), $("r"), n.add($("d"), 1), $("o"), $("i"), $("p"), n.seq(xqc.tpl(10, $("d"), "$>"), xqc.tpl(1, $("d"), 1)), n.and($("hasOp"), n.eq($("ocur").call($, "v"), 217)), xqc.tpl($("t"), $("d"), $("v")))) :
			(await n.when(n.eq($("v"), 216)) ?
				(await n.when(n.and($("hasOp"), n.eq($("ocur").call($, "v"), 219))) ?
					...
					(await n.when(n.geq($("v"), n.seq(214, 2108))) ?
						...
						(await n.when(n.eq($("v"), 219)) ?
							...
							(await n.when(n.eq($("v"), 2106)) ?
								( /* check if o contains declare, otherwise its anonymous */ $("hasDecl", n.and($("hasOp"), n.eq($("ocur").call($, "v"), 217))),
									...
									(await n.when(n.eq($("v"), 207)) ?
										...
										(await n.when(n.eq($("v"), 208)) ?
											...
											(await n.when(n.eq($("v"), 209)) ?
												( /* TODO check if o contains something that prevents creating a new let-ret-seq */ /* remove entry */ $("hasX", n.and($("hasOp"), n.geq($("ocur").call($, "v"), n.seq(222, 223, 224, 225)))),
													$("tmp", xqc.unwrap(xqc.tpl($("t"), $("d"), $("v")), $("tmp"))),
													$("d", $("tmp").call($, "d")),
												...
												(await n.when(n.eq($("v"), 210)) ?
													( /* remove let, variable or comma from o */ $("tmp", xqc.unwrap(xqc.tpl($("t"), $("d"), $("v")), $("tmp"))),
														...
														xqc.rtp($("tmp"), $("tmp").call($, "r"), $("tmp").call($, "d"), $("tmp").call($, "o"), $("tmp").call($, "i"), $("tmp").call($, "p"), xqc.tpl(3, $("d"), ","), n.and($("hasOp"), n.geq($("ocur").call($, "v"), n.seq(218, 209))), xqc.tpl($("t"), $("d"), $("v")))) :
													(await n.when(n.eq($("v"), 211)) ?
														...
														(await n.when(n.eq($("v"), 220)) ?
															...
															(await n.when(n.eq($("v"), 221)) ?
																( /* start x-for, add var to params */ await n.when(n.and($("hasOp"), n.eq($("ocur").call($, "v"), 222))) ?
																...
																(await n.when(n.geq($("v"), n.seq(222, 223, 224, 225))) ?
																	...
																	(await n.when(n.and(n.and(n.eq($("v"), 509), $("hasOp")), n.eq($("ocur").call($, "v"), 2108))) ?
																		(xqc.rtp($("tmp"), $("r"), $("d"), $("o"), $("i"), $("p"), xqc.tpl(3, $("d"), ","), n.true(), xqc.tpl($("t"), $("d"), $("v")))) :
																		(await n.when(n.or(n.seq(n.and(n.ge($("v"), 300), n.lt($("v"), 2100))), n.eq($("v"), 2600))) ?
																			(await n.when(n.eq($("size"), 0)) ?
																				...
																				($("prev", xqc.guardedGet($("r"), $("size"))),
																					$("isOcc", await n.when(n.geq($("v"), n.seq(802, 904, 2003))) ?
																						(await n.when(n.and(n.eq($("ocur").call($, "t"), 1), n.and(n.eq($("ocur").call($, "v"), 1), n.gt($("osize"), 1)))) ?
																							($("oprev", xqc.guardedGet($("o"), n.subtract($("osize"), 1))),
																								n.and(n.eq($("oprev").call($, "t"), 4), n.geq($("oprev").call($, "v"), n.seq(1200, 2400)))) :
																							(n.and($("hasOp"), n.eq($("ocur").call($, "v"), 2400)))) :
																						(n.false())),
																					...
																					(await n.when(n.and(n.geq($("v"), n.seq(801, 802)), n.geq($("prev").call($, "t"), n.seq(1, 3, 4)))) ?
																						($("v", n.add($("v"), 900)),
																							xqc.rtp($("tmp"), $("r"), n.add($("d"), 1), $("o"), $("i"), $("p"), n.seq(xqc.tpl($("t"), $("d"), xqc.opName($("v"))), xqc.tpl(1, $("d"), 1)), n.seq(), xqc.tpl($("t"), $("d"), $("v")))) :
																						( /* bin-op: pull in left side, add parens */ xqc.binOp(4, $("v"), $("tmp"), $("ocur"), $("hasPreOp")))))) :
																			(await n.when(n.and(n.gt($("v"), 2100), n.lt($("v"), 2200))) ?
																				(xqc.rtp($("tmp"), $("r"), $("d"), $("o"), $("i"), $("p"), xqc.tpl($("t"), $("d"), xqc.opName($("v"))), n.and($("hasPreOp"), n.ne($("ocur").call($, "v"), 1200)), xqc.tpl($("t"), $("d"), $("v")))) :
																				(xqc.rtp($("tmp"), $("r"), $("d"), $("o"), $("i"), $("p"), xqc.tpl($("t"), $("d"), xqc.opName($("v"))), n.and($("hasPreOp"), n.ne($("ocur").call($, "v"), 1200))))))))))))))))))))))
}));
xqc.processVar$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("v", $(1)),
		...
		$("v", n.replace($("v"), "^\\$", "")),
		$("tpl", await n.when(n.or(n.or($("isParam"), $("hasXass")), $("hasX"))) ?
			(n.seq()) :
			(await n.when(n.boolean($("hasAss"))) ?
				(xqc.tpl($("t"), $("d"), $("v"))) :
				(await n.when(n.eq($("v"), "")) ?
		...
		xqc.rtp($("tmp"), $("r"), $("d"), $("o"), $("i"), $("p"), $("tpl"), n.seq(), n.seq(), await n.when(n.or(n.or($("isParam"), $("hasXass")), $("hasX"))) ?
			($("v")) :
			(n.seq()))
}));
xqc.processQname$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("v", $(1)),
		...
		$("ocur", await n.when(n.gt($("osize"), 0)) ?
			...
			(map.map())),
		$("hasOp", n.eq($("ocur").call($, "t"), 4)),
		await n.when(n.and($("hasOp"), n.geq($("ocur").call($, "v"), n.seq(2102, 2105)))) ?
		( /*                let $nu := console:log(map {"auto-constr":$ocur,"i":$i}) return*/ $("tmp", xqc.rtp($("tmp"), a.pop($("r")), n.add($("d"), 1), $("o"), $("i"), $("p"), n.seq(xqc.tpl(4, $("ocur").call($, "d"), (xqc.constructors).call($, $("ocur").call($, "v"))), xqc.tpl(1, $("d"), 1), xqc.tpl(1, $("d"), 1, 3), xqc.tpl(7, n.add($("d"), 2), $("v")), xqc.tpl(2, n.add($("d"), 2), 4), xqc.tpl(3, n.add($("d"), 1), ",")), n.true(), xqc.tpl(4, $("ocur").call($, "d"), n.add($("ocur").call($, "v"), 900)))),
			map.put($("tmp"), "i", $("i"))) :
		($("tpl", await n.when(n.and($("hasOp"), n.eq($("ocur").call($, "v"), 2108))) ?
				(xqc.tpl(7, $("d"), $("v"))) :
				(await n.when(n.matches($("v"), "^xs:")) ?
					($("hasTypesig", n.and($("hasOp"), n.geq($("ocur").call($, "v"), n.seq(1200, 2400)))),
						$("hasTypesig", await n.when(n.and(n.eq($("hasTypesig"), n.false()), n.and(n.eq($("ocur").call($, "t"), 1), n.eq($("ocur").call($, "v"), 1)))) ?
							($("oprev", xqc.guardedGet($("o"), n.subtract($("osize"), 1))),
								n.and(n.eq($("oprev").call($, "t"), 4), n.geq($("oprev").call($, "v"), n.seq(1200, 2400)))) :
							($("hasTypesig"))),
...
xqc.charReducer$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("flags", $(1)),
		...
		$("type", await n.when(n.ne($("string"), 0)) ?
			( /* skip anything but closers */ await n.when(n.and(n.eq($("string"), 6), n.and(n.eq($("char"), "\""), n.ne($("next"), "\"")))) ?
				(6) :
				(await n.when(n.and(n.eq($("string"), 7), n.eq($("char"), "'"))) ?
					(7) :
					(0))) :
		...
		$("flag", await n.when(n.boolean($("number"))) ?
			...
			(await n.when(n.boolean($("zero"))) ?
				(await n.when(n.geq($("type"), n.seq(6, 7))) ?
					(1 /* open string */ ) :
					(await n.when(n.and(n.eq($("type"), 1), n.eq($("next"), ":"))) ?
						(3 /* open comment */ ) :
						(await n.when(n.eq($("type"), 507)) ?
							(await n.when(n.matches($("next"), "\\p{L}")) ?
								(5 /* open opentag */ ) :
								(await n.when(n.and(n.eq($("next"), "/"), n.gt(n.head($("opencount")), 0))) ?
									(7 /* open closetag */ ) :
									(n.seq()))) :
							(await n.when(n.and(n.eq($("type"), 3), n.and(n.ne($("oldType"), 3), n.and(n.ne($("next"), "{"), n.gt(n.head($("opencount")), 0))))) ?
								(11 /* open enc-expr */ ) :
								(await n.when(n.and($("encExpr"), n.and(n.eq($("type"), 4), n.and(n.eq($("hasQuot"), 0), n.ne($("next"), "}"))))) ?
									(12 /* close enc-expr */ ) :
									(n.seq())))))) :
				(await n.when(n.and($("string"), n.geq($("type"), n.seq(6, 7)))) ?
					(2 /* close string */ ) :
					(await n.when(n.and($("comment"), n.eq($("type"), 2502))) ?
						(4 /* close comment */ ) :
						(await n.when(n.and($("opentag"), n.eq($("type"), 505))) ?
							(6 /* close opentag */ ) :
							(await n.when(n.and($("closetag"), n.eq($("type"), 505))) ?
								(8 /* close closetag */ ) :
								(await n.when(n.and(n.and(n.eq($("attrkey"), n.false()), n.empty($("type"))), n.gt(n.head($("opencount")), 0))) ?
									(9) :
									(await n.when(n.and($("attrkey"), n.and(n.eq($("type"), 509), n.gt(n.head($("opencount")), 0)))) ?
										(10) :
										(n.seq()))))))))),
		...
		//console.log("bufferpre",$("buffer")),
		$("emitBuffer", await n.when(n.boolean($("flag"))) ?
			(await n.when(n.exists($("buffer"))) ?
				(await n.when(n.or(n.geq($("flag"), n.seq(2, 4)), n.eq(n.matches($("buffer"), "^\\s*$"), n.false()))) ?
					(n.stringJoin($("buffer"))) :
					(n.seq())) :
				(n.seq())) :
			(await n.when(n.boolean($("zero"))) ?
				(await n.when(n.boolean($("wasVar"))) ?
					...
					(await n.when(n.boolean($("wasNumber"))) ?
						(await n.when(n.boolean($("number"))) ?
							(n.seq()) :
							(n.stringJoin($("buffer")))) :
						(await n.when(n.and(n.eq($("type"), 2600), n.and(n.geq($("oldType"), n.seq(6, 7, 11)), n.ne($("next"), "=")))) ?
							($("char")) :
							(await n.when(n.eq($("type"), 10)) ?
								(await n.when(n.and(n.exists($("buffer")), n.matches(n.stringJoin($("buffer")), "^(group|instance|treat|cast|castable|order)$"))) ?
									(n.seq()) :
									($("char"))) :
								(await n.when(n.and(n.ne($("type"), 505), n.and(n.ne($("type"), 2600), n.and(n.ne($("type"), 509), n.and(n.ne($("type"), 9), n.and(n.ne($("type"), 11), n.and(n.ne($("type"), 12), n.and(n.ne($("type"), 14), n.ne($("type"), 0))))))))) ?
									( /* these arent blocks, unless theyre paired */ $("char")) :
									(await n.when(n.and(n.eq($("type"), 509), n.not(n.geq($("buffer"), n.seq(":", ">", "<", "!"))))) ?
										($("char")) :
										(n.seq()))))))) :
				(n.seq()))),
		$("tpl", await n.when(n.or(n.or(n.geq($("flag"), n.seq(2, 4, 6, 7, 8, 9, 10)), $("wasNumber")), $("wasVar"))) ?
			(n.seq()) :
			(await n.when(n.and(n.and($("emitBuffer"), n.exists($("buffer"))), $("xqCompat"))) ?
				(xqc.inspectBuf($("buffer"))) :
				(n.seq()))),
		//console.log("tpl",$("tpl")),
		...
		$("emitBuffer", await n.when(n.boolean($("fixQuotAnd"))) ?
			(n.seq()) :
			($("emitBuffer"))),
		//console.log("emitBuffer",$("emitBuffer")),
			...
			(await n.when(n.geq($("flag"), n.seq(4, 6, 8, 9, 10))) ?
				...
				(await n.when(n.boolean($("emitBuffer"))) ?
					(await n.when(n.eq($("type"), 8)) ?
						...
						(await n.when(n.and(n.eq($("type"), 10), n.empty($("buffer")))) ?
							(n.seq()) :
							(await n.when(n.or(n.geq($("flag"), n.seq(7, 11)), n.gt(n.head($("opencount")), 0))) ?
					...
					(n.seq())))),
		//console.log("tpl",$("tpl")),
		$("fromBuf", await n.when(n.and(n.and(n.empty($("flag")), $("emitBuffer")), $("zero"))) ?
		...
		$("flags", map.put($("flags"), "char", await n.when(n.eq($("flag"), 4)) ?
			(" ") :
			($("next")))),
		//console.log("out",$("flags").call($,"out")),
		$("flags", await n.when(n.or(n.eq($("type"), 5), n.empty($("next")))) ?
		...
		//console.log("emitBuffer",$("emitBuffer")),
		$("buffer",await n.when(n.or(n.or($("emitBuffer"), $("attrval")), n.geq($("flag"), n.seq(2, 6, 9)))) ?
			( /* TODO never buffer for some flags */ n.seq()) :
			(await n.when(n.and($("comment"), n.eq($("type"), 2600))) ?
		...
		$("flags", map.put($("flags"), "string", await n.when(n.or($("fixQuotAnd"), $("attrval"))) ?
			($("type")) :
		...
		$("flags", map.put($("flags"), "attrval", await n.when(n.eq($("flag"), 10)) ?
			(n.true()) :
			(await n.when(n.and($("attrval"), n.eq($("type"), 6))) ?
				(n.false()) :
				($("attrval"))))),
...
xqc.analyzeChars$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function analyzeChars$2(...$) {
	$ = n.frame($);
	return $("chars", $(1)),
		$("params", $(2)),
...
xqc.detectCxf = (...$) => {
	const $len = $.length;
	console.log("detectCxf",$len);
	if ($len == 1) return n.fromPromise(xqc.detectCxf$1.apply(null, $));
};
xqc.replaceDotless = (...$) => {
	const $len = $.length;
	console.log("replaceDotless",$len);
	if ($len == 3) return n.fromPromise(xqc.replaceDotless$3.apply(null, $));
};
xqc.isQname = (...$) => {
	const $len = $.length;
	console.log("isQname",$len);
	if ($len == 1) return n.fromPromise(xqc.isQname$1.apply(null, $));
};
xqc.inspectBuf = (...$) => {
	const $len = $.length;
	console.log("inspectBuf",$len);
	if ($len == 1) {
		var ret = n.fromPromise(xqc.inspectBuf$1.apply(null, $));
		console.log("inspect-buf-ret",ret);
		return ret;
	}
};
xqc.incr = (...$) => {
	const $len = $.length;
	console.log("incr",$len);
...
xqc.opName = (...$) => {
	const $len = $.length;
	console.log("opName",$len);
	if ($len == 1) return n.fromPromise(xqc.opName$1.apply(null, $));
};
xqc.guardedGet = (...$) => {
	const $len = $.length;
	console.log("guardedGet",$len);
	if ($len == 2) return n.fromPromise(xqc.guardedGet$2.apply(null, $),"guardedGet");
};
xqc.unwrap = (...$) => {
	const $len = $.length;
	console.log("unwrap",$len);
...
xqc.process = (...$) => {
	...
	if ($len == 2) {
		...
		const ret = xqc.process$2.apply(null, $)
		ret.then(() => {
			global.console.log("process$2",process.hrtime(start))
		});
		return n.fromPromise(ret);
	}
};
xqc.toL3 = (...$) => {
	const $len = $.length;
	console.log("toL3",$len)
	if ($len == 5) return n.fromPromise(xqc.toL3$5.apply(null, $));
};
xqc.toBuffer = (...$) => {
	const $len = $.length;
	console.log("toBuffer",$len)
	if ($len == 1) return n.fromPromise(xqc.toBuffer$1.apply(null, $));
};
xqc.normalizeQuery = (...$) => {
	const $len = $.length
	console.log("normalizeQuery",$len);
...
xqc.analyzeChar = (...$) => {
	...
	if ($len == 1) {
		const start = process.hrtime();
		const ret = xqc.analyzeChar$1.apply(null, $);
		ret.then(() => {
			global.console.log("analyzeChar$1",process.hrtime(start))
		});
		return n.fromPromise(ret);
	}
};
xqc.flagToExpr = (...$) => {
	...
	if ($len == 1) {
		const start = process.hrtime();
		var ret = xqc.flagToExpr$1.apply(null, $);
		ret.then(() => {
			global.console.log("flagToExpr$1",process.hrtime(start))
		})
		return n.fromPromise(ret);
	}
};
xqc.inspectTokens = (...$) => {
	const $len = $.length;
	console.log("inspectTokens",$len);
	if ($len == 2) return n.fromPromise(xqc.inspectTokens$2.apply(null, $));
};
xqc.charReducer = (...$) => {
	const $len = $.length;
	//console.log("charReducer",$len);
	return n.fromPromise(xqc.charReducer$2.apply(null, $));
};
xqc.analyzeChars = (...$) => {
	const $len = $.length;
	console.log("analyzeChars",$len)

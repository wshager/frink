		...
		if (test) {
			...
			return n.if(n.eq($v, 3), (test) => {
				if (test) {
					...
					let $r = n.if(n.boolean($hasLambda), (test) => {
						if (test) {
							return a.pop($r);
						} else {
							return $r;
...
xqc.toRdl$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), ((...a) => {
	let $pre = a[0];
	let $entry = a[1];
	let $t = $entry("t");
	let $v = $entry("v");
...
xqc.charReducer$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), ((...a) => {
	let $flags = a[0];
	let $next = a[1];
...
xqc.analyzeChars$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), ((...a) => {
	let $chars = a[0];
	let $params = a[1]; /* if the type changes, flush the buffer */
	/* TODO:
	 * WS for XML
...
xqc.toRdl = (...a) => {
	const len = a.length;
	if (len == 2) return xqc.toRdl$2.apply(null, a);
};
...
xqc.charReducer = (...a) => {
	const len = a.length;
	if (len == 2) return xqc.charReducer$2.apply(null, a);
};
xqc.analyzeChars = (...a) => {
	const len = a.length;

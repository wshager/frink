...
xqc.unwrap$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("cur", $(1)),
		...
		$("isClose", n.eq($("t"), 2)),
		$("isLet", n.eq($("type"), 209)),
		$("isBody", (await n.when(n.eq($("type"), 4)) && await n.when($("hasOp"))) && await n.when(n.eq($("ov"), 3106))),
		...
		$("pass", await n.when(n.eq($("type"), 209)) && await n.when((await n.when(n.eq($("has"), 207)) || (await n.when(n.eq($("hasOp"), n.false())) || (await n.when(n.eq($("ov"), 3106)) || await n.when(n.eq($("has"), 211))))))),
		$("pass", await n.when($("pass")) || ((await n.when(n.eq($("type"), 210)) || await n.when((await n.when(n.eq($("t"), 3)) && await n.when(n.eq($("has"), 1))))) || await n.when(n.eq($("osize"), 0)))),
		$("hasAf", n.eq($("has"), 4000)),
		$("hasXass", await n.when($("hasOp")) && (await n.when(n.eq($("ov"), 210)) && await n.when((await n.when($("isX")) || await n.when((await n.when($("hasAss")) && (await n.when(n.gt($("osize"), 1)) && (await n.when(n.eq($("o").call($, n.subtract($("osize"), 1)).call($, "t"), 4)) && await n.when(n.geq($("o").call($, n.subtract($("osize"), 1)).call($, "v"), n.seq(222, 223, 224, 225))))))))))),
		...
		$("matching", ((await n.when((await n.when(n.eq($("type"), 4)) && await n.when(n.eq($("has"), 3)))) || await n.when((await n.when(n.eq($("type"), 2)) && await n.when(n.eq($("has"), 1))))) || await n.when((await n.when(n.eq($("type"), 2002)) && await n.when(n.geq($("has"), n.seq(2001, 2004))))))),
		$("closeThen", await n.when(n.eq($("type"), 208)) && await n.when(n.eq($("has"), 207 /* else adds a closing bracket */ ))),
		$("isLetInElse", await n.when(n.eq($("has"), 208)) && (await n.when(n.eq($("isLet"), n.true())) && await n.when(n.eq(xqc.guardedGet($("r"), $("size")).call($, "t"), 1)))),
		...
		( /*            let $nu := console:log("stop")*/ $("tpl", (await n.when($("hasX")) || await n.when($("hasXass"))) ?
			...
			$("tpl", await n.when(n.boolean($("hasTuple"))) ?
				...
				(await n.when(n.boolean($("hasParam"))) ?
					...
					(((await n.when($("isXret")) || await n.when($("isX"))) || await n.when($("isXlet"))) ?
						($("tpl", n.seq($("tpl"), xqc.tpl(4, $("d"), (xqc.operators).call($, $("v"))), xqc.tpl(1, $("d"), 1), xqc.tpl(1, $("d"), 1, 3))),
							...
							(a.foldLeftAt($("p"), $("tpl"), n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), (async function(...$) {
								...
								return $("pre", $(1)),
									$("cur", $(2)),
									$("i", $(3)),
									n.seq($("pre"), xqc.tpl(10, $("d"), "$"), xqc.tpl(1, $("d"), 1), xqc.tpl(4, $("d"), 1, $("cur")), xqc.tpl(3, $("d"), 1, ","), xqc.tpl(4, $("d"), 1, "$"), xqc.tpl(1, $("d"), 1, 1), xqc.tpl(8, $("d"), 2, $("i")), xqc.tpl(2, $("d"), 1, 2), xqc.tpl(2, $("d"), 2), (await n.when($("isLet")) || await n.when(n.eq($("type"), 225))) ?
										(n.seq()) :
										(xqc.tpl(3, $("d"), ",")))
							}))))) :
										...
										((await n.when($("hasAf")) || await n.when($("isClose"))) ?
											($("closeCurly", await n.when(n.eq($("has"), 3)) ?
												...
												xqc.tpl($("t"), $("d"), await n.when(n.boolean($("closeCurly"))) ?
													($("v")) :
													(2))) :
											(((await n.when($("pass")) || await n.when($("closeThen"))) || await n.when($("hasXfor"))) ?
												(n.seq()) :
			...
			$("tmp", map.put($("tmp"), "r", await n.when(n.exists($("tpl"))) ?
				...
				($("r")))),
			$("tmp", map.put($("tmp"), "d", (await n.when((await n.when($("isBody")) || await n.when($("hasXret"))) || await n.when($("hasConstr"))) || await n.when((await n.when($("matching")) && await n.when(n.eq($("ov"), 2001))))) ?
				(n.subtract($("d"), 2)) :
				(await n.when(n.boolean($("isXret"))) ?
					(n.add($("d"), 1)) :
					((await n.when($("isX")) || await n.when($("isXlet"))) ?
						(n.add($("d"), 2)) :
						((await n.when(((await n.when($("hasAss")) || await n.when($("hasParam"))) || await n.when($("hasAf"))) || await n.when($("matching"))) || await n.when($("hasTuple"))) ?
							(n.subtract($("d"), 1)) :
							($("d"))))))),
			$("tmp", map.put($("tmp"), "o", $("o"))),
...
xqc.rtp$10 = n.typed(n.function(n.seq(n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.array(n.occurs(n.item(), n.zeroOrMore())), n.integer(), n.array(n.occurs(n.item(), n.zeroOrMore())), n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.array(n.occurs(n.item(), n.zeroOrMore())), n.occurs(n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.zeroOrMore()), n.occurs(n.boolean(), n.zeroOrOne()), n.occurs(n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.zeroOrOne()), n.occurs(n.string(), n.zeroOrOne())), n.item()), (async function(...$) {
	...
	return $("tmp", $(1)),
		...
		$("o", await n.when(n.boolean($("removeOp"))) ?
			...
			($("o"))),
		$("tmp", map.put($("tmp"), "r", await n.when(n.exists($("tpl"))) ?
			(n.foldLeft($("tpl"), $("r"), function(acc,x) {
...
xqc.processOpen$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("v", $(1)),
		...
		$("hasPreOp", await n.when($("hasOp")) && (await n.when(n.gge($("ocur").call($, "v"), 300)) && await n.when(n.glt($("ocur").call($, "v"), 2100)))),
		await n.when(n.eq($("v"), 2001)) ?
		...
		(await n.when(n.eq($("v"), 3)) ?
			($("hasRettype", await n.when($("hasOp")) && await n.when(n.geq($("ocur").call($, "v"), 2400))),
				...
				$("hasConstrType", (await n.when(n.eq($("hasParams"), n.false())) && await n.when($("hasOp"))) && (await n.when(n.gt($("ocur").call($, "v"), 3000)) && await n.when(n.lt($("ocur").call($, "v"), 3100 /*                let $nu := console:log(($d,", has-params: ",$has-params,", has-rettype: ",$has-rettype))*/ )))),
				$("cur", xqc.tpl($("t"), $("d"), $("v"))),
			...
			( /* detect first opening bracket after function declaration */ /* detect parameters, we need to change 2106 to something else at opening bracket here */ $("hasFunc", await n.when($("hasOp")) && await n.when(n.eq($("ocur").call($, "v"), 2106))),
				$("hasConstrType", (await n.when(n.eq($("hasFunc"), n.false())) && await n.when($("hasOp"))) && (await n.when(n.gt($("ocur").call($, "v"), 2100)) && await n.when(n.lt($("ocur").call($, "v"), 2200)))),
				console.log("hasConstrType",$("hasConstrType")),
														...
														(await n.when(n.eq($("v"), 220)) ?
															...
															(await n.when(n.eq($("v"), 221)) ?
																...
																(await n.when(n.geq($("v"), n.seq(222, 223, 224, 225))) ?
																	...
																	(((await n.when(n.eq($("v"), 509)) && await n.when($("hasOp"))) && await n.when(n.eq($("ocur").call($, "v"), 2108))) ?
																			...
																			(await n.when(n.eq($("size"), 0)) ?
																				...
																				($("prev", xqc.guardedGet($("r"), $("size"))),
																					$("isOcc", await n.when(n.geq($("v"), n.seq(802, 904, 2003))) ?
																						((await n.when(n.eq($("ocur").call($, "t"), 1)) && (await n.when(n.eq($("ocur").call($, "v"), 1)) && await n.when(n.gt($("osize"), 1)))) ?
...
xqc.processVar$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("v", $(1)),
		...
		$("hasXass", await n.when($("hasAss")) && (await n.when(n.gt($("osize"), 1)) && (await n.when(n.eq($("o").call($, n.subtract($("osize"), 1)).call($, "t"), 4)) && await n.when(n.geq($("o").call($, n.subtract($("osize"), 1)).call($, "v"), n.seq(222, 223, 224, 225)))))),
		$("v", n.replace($("v"), "^\\$", "")),
		$("tpl", ((await n.when($("isParam")) || await n.when($("hasXass"))) || await n.when($("hasX"))) ?
			(n.seq()) :
			(await n.when(n.boolean($("hasAss"))) ?
				(xqc.tpl($("t"), $("d"), $("v"))) :
				(await n.when(n.eq($("v"), "")) ?
		...
		xqc.rtp($("tmp"), $("r"), $("d"), $("o"), $("i"), $("p"), $("tpl"), n.seq(), n.seq(), ((await n.when($("isParam")) || await n.when($("hasXass"))) || await n.when($("hasX"))) ?
			($("v")) :
			(n.seq()))
}));
		...
		($("tpl", (await n.when($("hasOp")) && await n.when(n.eq($("ocur").call($, "v"), 2108))) ?
				...
				(await n.when(n.matches($("v"), "^xs:")) ?
					($("hasTypesig", await n.when($("hasOp")) && await n.when(n.geq($("ocur").call($, "v"), n.seq(1200, 2400)))),
						$("hasTypesig", (await n.when(n.eq($("hasTypesig"), n.false())) && (await n.when(n.eq($("ocur").call($, "t"), 1)) && await n.when(n.eq($("ocur").call($, "v"), 1)))) ?
							($("oprev", xqc.guardedGet($("o"), n.subtract($("osize"), 1))),
								await n.when(n.eq($("oprev").call($, "t"), 4)) && await n.when(n.geq($("oprev").call($, "v"), n.seq(1200, 2400)))) :
							($("hasTypesig"))),
...
xqc.charReducer$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("flags", $(1)),
		...
		$("type", await n.when(n.ne($("string"), 0)) ?
			( /* skip anything but closers */ (await n.when(n.eq($("string"), 6)) && (await n.when(n.eq($("char"), "\"")) && await n.when(n.ne($("next"), "\"")))) ?
				(6) :
		...
		$("number", (await n.when(n.eq($("var"), n.false())) && await n.when($("zero"))) && (await n.when(n.eq($("type"), 11)) && await n.when((await n.when((await n.when(n.ne($("oldType"), 12)) && await n.when(n.ne($("oldType"), 14)))) || await n.when($("wasWs")))))),
						...
						(await n.when(n.eq($("type"), 507)) ?
							(await n.when(n.matches($("next"), "\\p{L}")) ?
								...
								((await n.when(n.eq($("next"), "/")) && await n.when(n.gt(n.head($("opencount")), 0))) ?
									(7 /* open closetag */ ) :
									(n.seq()))) :
							((await n.when(n.eq($("type"), 3)) && (await n.when(n.ne($("oldType"), 3)) && (await n.when(n.ne($("next"), "{")) && await n.when(n.gt(n.head($("opencount")), 0))))) ?
								(11 /* open enc-expr */ ) :
								((await n.when($("encExpr")) && (await n.when(n.eq($("type"), 4)) && (await n.when(n.eq($("hasQuot"), 0)) && await n.when(n.ne($("next"), "}"))))) ?
									(12 /* close enc-expr */ ) :
									(n.seq())))))) :
					...
					((await n.when($("comment")) && await n.when(n.eq($("type"), 2502))) ?
						...
						((await n.when($("opentag")) && await n.when(n.eq($("type"), 505))) ?
							...
							((await n.when($("closetag")) && await n.when(n.eq($("type"), 505))) ?
								(8 /* close closetag */ ) :
								(((await n.when(n.eq($("attrkey"), n.false())) && await n.when(n.empty($("type")))) && await n.when(n.gt(n.head($("opencount")), 0))) ?
									(9) :
									((await n.when($("attrkey")) && (await n.when(n.eq($("type"), 509)) && await n.when(n.gt(n.head($("opencount")), 0)))) ?
										(10) :
										(n.seq()))))))))),
				...
				(await n.when(n.boolean($("wasVar"))) ?
					...
					(await n.when(n.boolean($("wasNumber"))) ?
						(await n.when(n.boolean($("number"))) ?
							(n.seq()) :
							(n.stringJoin($("buffer")))) :
						((await n.when(n.eq($("type"), 2600)) && (await n.when(n.geq($("oldType"), n.seq(6, 7, 11))) && await n.when(n.ne($("next"), "=")))) ?
							($("char")) :
							(await n.when(n.eq($("type"), 10)) ?
								((await n.when(n.exists($("buffer"))) && await n.when(n.matches(n.stringJoin($("buffer")), "^(group|instance|treat|cast|castable|order)$"))) ?
									(n.seq()) :
									($("char"))) :
								((await n.when(n.ne($("type"), 505)) && (await n.when(n.ne($("type"), 2600)) && (await n.when(n.ne($("type"), 509)) && (await n.when(n.ne($("type"), 9)) && (await n.when(n.ne($("type"), 11)) && (await n.when(n.ne($("type"), 12)) && (await n.when(n.ne($("type"), 14)) && await n.when(n.ne($("type"), 0))))))))) ?
									( /* these arent blocks, unless theyre paired */ $("char")) :
									((await n.when(n.eq($("type"), 509)) && await n.when(n.not(n.geq($("buffer"), n.seq(":", ">", "<", "!"))))) ?
										($("char")) :
										(n.seq()))))))) :
				(n.seq()))),
		$("tpl", ((await n.when(n.geq($("flag"), n.seq(2, 4, 6, 7, 8, 9, 10))) || await n.when($("wasNumber"))) || await n.when($("wasVar"))) ?
			(n.seq()) :
			(((await n.when($("emitBuffer")) && await n.when(n.exists($("buffer")))) && await n.when($("xqCompat"))) ?
		...
		$("tpl", await n.when(n.eq($("flag"), 2)) ?
			...
			(await n.when(n.geq($("flag"), n.seq(4, 6, 8, 9, 10))) ?
				...
				(await n.when(n.boolean($("emitBuffer"))) ?
					...
					(n.seq())))),
		console.log("tpl",$("tpl")),
		$("fromBuf", ((await n.when(n.empty($("flag"))) && await n.when($("emitBuffer"))) && await n.when($("zero"))) ?
		...
		$("flags", map.put($("flags"), "buffer", ((await n.when($("emitBuffer")) || await n.when($("attrval"))) || await n.when(n.geq($("flag"), n.seq(2, 6, 9)))) ?
...
xqc.process = (...$) => {
	const $len = $.length;
	//global.console.log("process",$len)
...
xqc.charReducer = (...$) => {
	const $len = $.length;
	//global.console.log("charReducer",$len)

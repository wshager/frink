...
xqc.inspectBuf$3 = n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), (async function(...$) {
	...
	/*        return*/ await n.when(n.eq(map.contains((xqc.opInv), $("s")), n.false())) ?
		...
		$("ret", (await n.when(n.gt($("ret"), 2100)) && await n.when(n.lt($("ret"), 2200))) ?
			...
			$("tpl", await n.when(n.boolean($("hasParams"))) ?
				...
				(await n.when(n.boolean($("hasConstrType"))) ?
					...
					(await n.when(n.boolean($("hasOp"))) ?
						...
						($("cur"))))),
			console.log("tpl",$("tpl")),
			console.log("has",$("hasParams")),
			/* remove constr type if not constr */
			$("tmp",xqc.rtp($("tmp"), $("r"), await n.when(n.boolean($("hasParams"))) ?
				($("d")) :
...
xqc.toRdl$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	...
	$("t", $("entry").call($, "t")),
	$("v", $("entry").call($, "v")),
	array.append($("pre"), await n.when(n.geq($("t"), n.seq(1, 2))) ?
		((xqc.operators).call($, $("v"))) :
		(await n.when(n.eq($("t"), 7)) ?
			(n.concat("\"", $("v"), "\"")) :
			(await n.when(n.eq($("t"), 9)) ?
...
xqc.charReducer$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
				...
				(await n.when(n.boolean($("wasNumber"))) ?
					...
					((await n.when(n.eq($("type"), 2600)) && await n.when(await n.when(n.geq($("oldType"), n.seq(6, 7, 11))) && await n.when(n.ne($("next"), "=")))) ?
						...
						(await n.when(n.eq($("type"), 10)) ?
							((await n.when(n.exists($("buffer"))) && await n.when(n.matches($("buffer"), "^(group|instance|treat|cast|castable|order)$"))) ?
								(n.seq()) :
								($("char"))) :
							((await n.when(n.ne($("type"), 505)) && await n.when(await n.when(n.ne($("type"), 2600)) && await n.when(await n.when(n.ne($("type"), 509)) && await n.when(await n.when(n.ne($("type"), 9)) && await n.when(await n.when(n.ne($("type"), 11)) && await n.when(await n.when(n.ne($("type"), 12)) && await n.when(await n.when(n.ne($("type"), 14)) && await n.when(n.ne($("type"), 0))))))))) ?
								...
								((await n.when(n.eq($("type"), 509)) && await n.when(n.eq(n.matches($("buffer"), "[:><!]"), n.false()))) ?
									($("char")) :
									(n.seq()))))))) :
			(n.seq()))),
	$("tpl", (await n.when(await n.when(n.geq($("flag"), n.seq(2, 4, 6, 7, 8, 9, 10))) || await n.when($("wasNumber"))) || await n.when($("wasVar"))) ?
		(n.seq()) :
		((await n.when($("emitBuffer")) && await n.when(await n.when(n.ne($("buffer"), "")) && await n.when($("xqCompat")))) ?
			(xqc.inspectBuf($("buffer"), $("type"), $("next"))) :
			(n.seq()))),
	$("fixQuot", (await n.when(n.exists($("tpl"))) && (await n.when(n.eq($("tpl").call($, "t"), 7)) && await n.when(n.eq($("type"), 6))))),
		...
		(await n.when(n.geq($("flag"), n.seq(4, 6, 8, 9, 10))) ?
			...
			(await n.when(n.boolean($("emitBuffer"))) ?
				(await n.when(n.eq($("type"), 8)) ?
					...
					((await n.when(n.eq($("type"), 10)) && await n.when(n.eq($("buffer"), ""))) ?
						(n.seq()) :
	...
	$("flags", (await n.when(n.eq($("type"), 5)) || await n.when(n.empty($("next")))) ?
		...
		await n.when(n.boolean($("s"))) ?
			($("out", await n.when(n.eq($("output"), "l3")) ?
	...
	$("flags", map.put($("flags"), "buffer", (await n.when(await n.when($("emitBuffer")) || await n.when($("attrval"))) || await n.when(n.geq($("flag"), n.seq(2, 6, 9)))) ?
		...
		((await n.when($("comment")) && await n.when(n.eq($("type"), 2600))) ?
			( /* prevent buffering colons in comments */ await n.when(n.eq($("buffer"), "")) ?
				("") :
				(await n.when(n.eq($("next"), ")")) ?
					($("buffer")) :
...
xqc.state$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	$ = n.frame($);
	return $("buffer", $(1)),
	$("fn", $(2)),
	n.typed(n.function(n.seq(n.item()), n.item()), (async function(...$) {
		$ = n.frame($, this);
		return $("v", $(1)),
		await n.when(n.empty($("v"))) ?
			($("buffer")) :
...
xqc.analyzeChars$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
	...
	/* TODO:
		 ...
		 */
	$("m",map.map(n.pair("xq-compat", n.eq($("params").call($, "$compat"), "xquery")), n.pair("char", n.head($("chars"))), n.pair("type", 0), n.pair("buffer", ""), n.pair("string", 0), n.pair("var", n.false()), n.pair("ws", n.false()), n.pair("number", n.false()), n.pair("comment", n.false()), n.pair("opentag", n.false()), n.pair("closetag", n.false()), n.pair("attrkey", n.false()), n.pair("attrval", n.false()), n.pair("enc-expr", n.false()), n.pair("has-quot", 0), n.pair("opencount", 0), n.pair("r", array.array()), n.pair("d", 1), n.pair("o", array.array()), n.pair("i", map.map()), n.pair("p", array.array()), n.pair("out", xqc.state(n.seq(), n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (async function(...$) {
		$ = n.frame($, this);
		return $("buffer", $(1)),
		$("v", $(2)),
		console.log("v",$("v")),

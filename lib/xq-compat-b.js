		...
		return n.forEach(n.and(n.eq($x("t"), "6"), n.geq($x("v"), xqc.cxf0)), test => {
			if (test) {
				...
				return n.forEach(n.or($dotless, $dot), test => {
					if (test) {
						return array.append($acc, n.map(n.pair("qname", $x("v")), n.pair("at", $at), n.pair("dotless", $dotless)));
					} else {
						return $acc;
					}
				});
...
xqc.replaceDotless$3 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $r = a[0];
	let $offset = a[1];
	let $cxfs = a[2];
	return a.foldRightAt($cxfs, $r, n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
		let $r = a[0];
		let $cxf = a[1];
		//let $at = a[2];
...
xqc.isQname$1 = n.quoteTyped(n.function(n.seq(n.item()), n.item()), ((...a) => {
...
xqc.inspectBuf$1 = n.quoteTyped(n.function(n.seq(n.item()), n.item()), ((...a) => {
	let $s = a[0];
								...
								if (test) {
									...
									return n.forEach(n.eq(n.xFilter($s, ((...a) => {
										...
										if (test) {
											...
											return n.map(n.pair("t", 14), n.pair("v", $s));
										}
									});
								}
							});
...
xqc.incr$1 = n.quoteTyped(n.function(n.seq(n.item()), n.item()), ((...a) => {
	let $a = a[0];
...
xqc.tpl$3 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $t = a[0];
	let $d = a[1];
	let $v = a[2];
	return n.map(n.pair("t", $t), n.pair("d", $d), n.pair("v", $v));
}));
xqc.opName$1 = n.quoteTyped(n.function(n.seq(n.item()), n.item()), ((...a) => {
	let $v = a[0];
...
xqc.guardedGet$2 = n.quoteTyped(n.function(n.seq(n.item(), n.item()), n.item()), ((...a) => {
	let $r = a[0];
	let $size = a[1];
	let $last = $r($size);
...
xqc.unwrap$6 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $cur = a[0];
	let $r = a[1];
	let $d = a[2];
	let $o = a[3];
	...
	//let $nu = console.log(n.map(n.pair("t", $t), n.pair("v", $v), n.pair("d", $d), n.pair("has", $has), n.pair("has-tuple", $hasTuple), n.pair("matching", $matching), n.pair("ocur", $ocur), n.pair("has-typesig", $hasTypesig) /*        "has-constr-type":$has-constr-type,*/ /*        "has-param":$has-param,*/ /*        "has-ass":$has-ass,*/ /*        "is-body":$is-body, */ , n.pair("pass", $pass) /*        "has-x":$has-x,*/ , n.pair("ret", $r)));
		...
		if (test) {
			...
			return n.forEach(n.and($matching, n.eq($has, 2001)), test => {
				if (test) {
					...
					let $flat = array.flatten(array.forEach($cxfs, n.quoteTyped(n.function(n.seq(n.item()), n.item()), ((...a) => {
						let $x = a[0];
						return $x("qname");
					}))));
					...
					return n.forEach(n.boolean($hasCxf), test => {
						if (test) {
							...
							return array.join(n.seq(array.subarray($r, 1, n.minus($index, 1)), n.array(xqc.tpl(4, $d, "geq"), xqc.tpl(1, $d, 1), xqc.tpl(6, $d, "position"), xqc.tpl(1, $d, 1), xqc.tpl(13, $d, "."), xqc.tpl(2, $d, 2), xqc.tpl(3, $d, ",")), xqc.replaceDotless(array.subarray($r, $index), 0, $cxfs), n.array(xqc.tpl(2, $d, 2))));
						}
					});
				} else {
					return $r;
...
xqc.rtp$5 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $r = a[0];
	let $d = a[1];
	let $o = a[2];
	let $i = a[3];
...
xqc.rtp$6 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $r = a[0];
	let $d = a[1];
	let $o = a[2];
	let $i = a[3];
...
xqc.rtp$7 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $r = a[0];
	let $d = a[1];
	let $o = a[2];
	let $i = a[3];
...
xqc.rtp$8 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $r = a[0];
	let $d = a[1];
	let $o = a[2];
	let $i = a[3];
...
xqc.binOp$9 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $t = a[1];
	let $v = a[2];
	let $d = a[3];
...
xqc.processOpen$6 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $v = a[1];
	let $d = a[2];
	let $o = a[3];
...
xqc.processComma$6 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $v = a[1];
	let $d = a[2];
	let $o = a[3];
...
xqc.processOp$6 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $v = a[1];
	let $d = a[2];
	let $o = a[3];
...
xqc.processVar$6 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $v = a[1];
	let $d = a[2];
	let $o = a[3];
...
xqc.processQname$6 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $v = a[1];
	let $d = a[2];
	let $o = a[3];
...
/*
		 ...
		 */
xqc.process$6 = n.quoteTyped(n.function(n.seq(n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.array(n.occurs(n.item(), n.zeroOrMore())), n.integer(), n.array(n.occurs(n.item(), n.zeroOrMore())), n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore())), n.array(n.occurs(n.item(), n.zeroOrMore()))), n.item()), ((...a) => {
	let $cur = a[0];
	let $ret = a[1];
	let $d = a[2];
	let $o = a[3];
...
xqc.toL3$5 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $pre = a[0];
	let $entry = a[1];
	let $at = a[2];
	let $normalform = a[3];
...
xqc.toBuffer$1 = n.quoteTyped(n.function(n.seq(n.string()), n.item()), ((...a) => {
	let $query = a[0];
	return n.xForEach(n.stringToCodepoints($query), n.codepointsToString(a[0]));
}));
xqc.normalizeQuery$2 = n.quoteTyped(n.function(n.seq(n.string(), n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore()))), n.item()), ((...a) => {
	let $query = a[0];
...
xqc.normalizeQueryB$2 = n.quoteTyped(n.function(n.seq(n.occurs(n.string(), n.zeroOrMore()), n.map(n.anyAtomicType(), n.occurs(n.item(), n.zeroOrMore()))), n.item()), ((...a) => {
	let $buffer = a[0];
...
/*
		...
		*/
/* blocking chars */
xqc.analyzeChar$1 = n.quoteTyped(n.function(n.seq(n.item()), n.item()), ((...a) => {
	let $char = a[0];
...
xqc.flagToExpr$1 = n.quoteTyped(n.function(n.seq(n.item()), n.item()), ((...a) => {
	let $flag = a[0];
...
xqc.inspectTokens$2 = n.quoteTyped(n.function(n.seq(n.item(), n.item()), n.item()), ((...a) => {
	let $char = a[0];
	let $type = a[1];
...
xqc.analyzeChars$2 = n.quoteTyped(n.function(n.seq(n.item(), n.item()), n.item()), ((...a) => {
	let $chars = a[0];
	let $xqCompat = a[1];
...
xqc.analyzeChars$18 = n.quoteTyped(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), ((...a) => {
	let $ret = a[0];
	let $chars = a[1];
	let $xqCompat = a[2];
	let $char = a[3];
				...
				if (test) {
					...
					return n.forEach(n.boolean($emitBuffer), test => {
						if (test) {
							return n.forEach(n.eq($type, "8"), test => {
								if (test) {
									return n.map(n.pair("t", 13), n.pair("v", $char));
								} else {

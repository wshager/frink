...
xqc.inspectBuf$1 = n.typed(n.function(n.seq(n.item()), n.item()), ((...$) => {
	...
	return n.if(n.empty($s), (test) => {
		if (test) {
			...
			console.log("$RET",$ret);
			return n.if(n.or(n.empty($ret), n.instanceOf($ret, n.array(n.occurs(n.item(), n.zeroOrMore())))), ($ret,test) => {
				if (test) {
...
xqc.unwrap$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), ((...$) => {
	...
	return n.if(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.eq($osize, 0), $pass), $hasAss), $isBody), $isLetInElse), $hasTypesig), $hasParam), $hasAf), $matching), $closeThen), $isXret), $hasXret), $isX), $hasX), $hasXfor), $hasConstr), $hasTuple), n.eq($has, 11)), (test) => {
		if (test) { /*            let $nu := console:log("stop")*/
			...
			$d = n.if(n.or($hasX, $hasXass), ($d,test) => {
				if (test) {
			...
			$o = n.if(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or(n.or($hasParam, $hasConstr), n.seq(n.and($hasAss, n.ne(xqc.guardedGet($r, $size)("t"), 3)))), $isBody), $hasAf), $matching), $closeThen), $isXret), $isX), $hasTuple), ($o, test) => {
				if (test) {
					return a.pop($o);
				} else {
					return $o;
			...
			$r = n.if(n.and($hasOp, n.seq(n.or(n.gt($ov, 3000), $hasConstrType))), ($r,test) => {
				if (test) {
					return $r;
				} else {
...
xqc.charReducer$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), ((...$) => {
	...
	let $tpl = n.if(n.or(n.or(n.geq($flag, n.seq(2, 4, 6, 7, 8, 9, 10)), $wasNumber), $wasVar), (test) => {
		if (test) {
			return n.seq();
		} else {
	...
	let $fromBuf = n.if(n.and(n.and(n.empty($flag), $emitBuffer), $zero), (test) => {
		if (test) {
...
xqc.analyzeChars$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), ((...$) => {
	...
	return xqc.charReducer(n.foldLeft(n.tail($chars), $flags, xqc.charReducer), n.seq());
}));
xqc.detectCxf = (...$) => {
	const len = $.length;

...
exports.first = exports.seqFrom = exports.skip = exports.take = exports.compose = exports.foldLeft = exports.filter = exports.forEach = undefined;
...
var forEach = exports.forEach = _operators.map;
var filter = exports.filter = _operators.filter;
var foldLeft = exports.foldLeft = _operators.reduce;

// manual override...
var seqFrom = exports.seqFrom = function seqFrom(x) {
...
function seq() {
	...
	if (a.length == 1) {
		...
		if (Array.isArray(x) || x[Symbol.iterator] && typeof x != "string" && !(0, _access.isVNode)(x)) return _Observable.Observable.from(x);

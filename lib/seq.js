...
Object.defineProperty(exports, "interval", {
  enumerable: true,
  get: function () {
    return _rxjs.interval;
  }
});
exports.switchMap = exports.switchMapCurried = exports.first = exports.scanCurried = exports.foldLeftCurried = exports.filterCurried = exports.forEachCurried = exports.isSeq = exports.fromArgs = exports.isSingle = exports.isMaybe = exports.Single = exports.Maybe = void 0;
...
const foldLeftCurried = fn => $seed => $a => isSeq($a) ? (0, _rxjs.pipe)((0, _operators.reduce)((a, x) => fn(a, x), $seed), switchMapCurried(_util.id))($a) : fn($seed, $a);
...
const scanCurried = fn => $seed => $a => isSeq($a) ? (0, _rxjs.pipe)((0, _operators.scan)((a, x) => fn(a, x), $seed), forEachCurried(x => x))($a) : fn($seed, $a);

...
function analyzeString($str, $pat) {
	return _seq.forEach((0, _type.string)($str),function (str) {
...
function substring($str, $s, $l) {
	return  _seq.forEach((0, _type.string)((0, _seq.zeroOrOne)($str),function (str) {
...
function replace($str, $pat, $rep) {
	return  _seq.forEach((0, _type.string)((0, _seq.zeroOrOne)($str),function (str) {
		return _seq.forEach((0, _seq.exactlyOne)($pat),function (pat) {
			return _seq.forEach((0, _seq.exactlyOne)($rep),function (rep) {
...
function stringJoin($seq, $sep) {
	...
	return (0, _type.string)(_seq.forEach((0, _type.string)($seq, _seq.seq).reduce(function () {
		...
		return (0, _util.isUndef)($sep) ? a.join("") : (0, _seq.seq)($sep).map(function (sep) {
			return a.join(sep);
		});
	}));
}

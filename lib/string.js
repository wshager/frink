...
function analyzeString($str, $pat) {
	...
	var ret = (0, _vnode.e)("fn:analyze-string-result");
	var index = 0;
	if (str) {
		...
		_xregexp2.default.replace(str.toString(), _cached(pat), function (...args) {
			...
			var idx = args.pop();
			// the rest is groups
			if (idx > index) ret = (0, _modify.appendChild)(ret, (0, _vnode.e)("fn:non-match", (0, _vnode.x)(str.substring(index, idx))));
			index = idx + match.length;
			var len = args.length;
			var me = (0, _vnode.e)("fn:match");
			if (len > 0) {
				var children = [];
				for (let i = 0; i < len; i++) {
					let _ = args[i];
					if (_ !== undefined) {
						...
						// TODO nested groups
						if (_ !== "") {
							let ge = (0, _vnode.e)("fn:group", (0, _seq.seq)((0, _vnode.a)("nr", Number(i + 1)), (0, _vnode.x)(_)));
							children.push(ge);
							me = (0, _modify.appendChild)(me, ge);
						} else {
							var clen = children.length;
							if(clen){
								var last = children[clen - 1];
								last = (0, _modify.appendChild)(last, (0, _vnode.e)("fn:group", (0, _seq.seq)((0, _vnode.a)("nr", Number(i + 1)))));
							}
						}
					}
				}
				...
				me = (0, _modify.appendChild)(me, (0, _vnode.x)(match));
				ret = (0, _modify.appendChild)(ret, me);
			}
		});
		if (index < str.length) ret = (0, _modify.appendChild)(ret, (0, _vnode.e)("fn:non-match", (0, _vnode.x)(str.substr(index))));
	}
	return ret;
}
...
function matches($str, $pat) {
	...
	str = (0, _access.isNode)(str) ? str.data() : str;

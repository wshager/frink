...
exports.forEach = function($a,$f){
	return _transducers.forEach(_seq.first($a),_seq.first($f));
}
exports.filter = function($a,$f){
	return _transducers.filter(_seq.first($a),_seq.first($f));
}
exports.foldLeft = function($a,$z,$f){
	return _transducers.foldLeft(_seq.first($a),$z,_seq.first($f));
}

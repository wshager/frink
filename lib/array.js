...
List.prototype["@@transducers/init"] = function () {
	return rrb.empty;
};

List.prototype["@@transducers/step"] = function (l, x) {
	return l.push(x);
};

List.TreeIterator.prototype["@@transducers/result"] = function (l) {
	return l;
};

rrb.TreeIterator.prototype["@@transducers/init"] = function () {
	return rrb.empty;
};

rrb.TreeIterator.prototype["@@transducers/step"] = function (l, x) {
	return l.push(x);
};

rrb.TreeIterator.prototype["@@transducers/result"] = function (l) {
	return l;
};
...
function flatten($a) {
	return t.into($a, t.compose(t.cat, t.filter(_ => _ !== undefined)), _seq.seq());
}

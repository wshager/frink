...
function array() {
	...
	if (l == 1) {
		var s = a[0];
		if ((0, _seq.isSeq)(s)) return _seq.seq(s.reduce((acc,x) => acc.push(x),rrb.empty));
...
function _checked($a, fn) {
	...
	if ($a === undefined) return (0, _error.error)("XPTY0004");
	return (0, _seq.exactlyOne)($a).mergeMap(function (a) {
...
function subarray($a, $s, $l) {
	return (0, _seq.exactlyOne)($a).mergeMap(function (a) {
		return (0, _seq.seq)($s).mergeMap(function (s) {
			s = s.valueOf() - 1;

...
function arraySeq(s) {
	if(s && s.__is_ArraySeq) return s;
	s = _seq.seq(s);
	s.__callable = function(index) {
...
function array() {
	...
	return arraySeq((0, _seq.from)(a.map(x =>_seq.seq(x))).concatAll().reduce(function (acc,a) {
		return acc.push(a);
	},rrb.empty));
}
...
function join($a) {
	...
	return arraySeq(_seq.seq($a).reduce(function (pre, cur) {
...
function _checked($a, fn) {
	...
	if ($a === undefined) return (0, _error.error)("XPTY0004");
	return arraySeq((0, _seq.exactlyOne)($a).concatMap(function (a) {
...
function insertBefore($a, $i, $v) {
	return arraySeq((0, _seq.seq)($i).concatMap(function (i) {
...
function get($a, $i) {
	...
	return (0, _seq.exactlyOne)($i).concatMap(function (i) {
		return _seq.exactlyOne($a).concatMap(function (a) {
			if (a.size) return _seq.seq(a.get(i - 1));
			return _seq.seq();
		});
	});
}

...
function _formNodeToSchema(node) {
	...
	if (inode.type == "select-one") {
		s.enum = (0, _util.pipe)((0, _util.forEach)(function (o) {
			return o.value;
		}))(inode.options);
	}
	return s;
...
function validate($node, $schema) {
	...
	return $node.concatMap(function (node) {
		return (0, _seq.exactlyOne)($schema).concatMap(function (schema) {
...
var validator = {
	...
	type: function type(schema, key, params, index, path, err, node) {
		...
		if (type instanceof Array) {
			ret = (0, _util.foldLeft)((0, _util.forEach)(type, function (t) {
				return types[t](node);
			}), false, function (r, z) {
				return r || z;
			});

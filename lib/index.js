...
exports.false = () => false;
exports.true = () => true;
exports.if = (c,t,f) => _seq.forEach(_seq.boolean(c),ret => ret ? t.apply() : f.apply());
...
exports.toJS = _compiler.toJS;
exports.run = _compiler.run;
exports.compile = _compiler.compile;

...
exports.exactlyOne = exports.oneOrMore = exports.zeroOrOne = exports.insertBefore = exports.count = exports.exists = exports.empty = exports.isEmptySeq = exports.first = exports.isSeq = exports.seq = exports.jsFromL3 = exports.jsToL3 = exports.iterJS = exports.toJS = exports.fromJS = exports.removeChild = exports.insertChildBefore = exports.appendChild = undefined;
...
Object.defineProperty(exports, "zeroOrOne", {
    enumerable: true,
    get: function () {
        return _seq.zeroOrOne;
    }
});
Object.defineProperty(exports, "oneOrMore", {
    enumerable: true,
    get: function () {
        return _seq.oneOrMore;
    }
});
Object.defineProperty(exports, "exactlyOne", {
    enumerable: true,
    get: function () {
        return _seq.exactlyOne;
    }
});
...
Object.keys(_transducers).forEach(function (key) {
    if (key === "default" || key === "__esModule" || key === "filter") return;
    Object.defineProperty(exports, key, {
        enumerable: true,
        get: function () {
...
Object.defineProperty(exports, "filter", {
    enumerable: true,
    get: function () {
        return function(iterable,f){
            if(arguments.length == 1) return _transducers.filter(iterable);
            return _transducers.filter(iterable,function(v,k,i){
                if(!_seq.isSeq(v) && !_access.isNode(v)) v = _seq.seq(v);
                v.__cx = [k,i];
                return f(v,k,i);
            });
        };

...
function parseRdl(path) {
	return fromL3Stream(rdl.parse(path));
}
function parseRdlString(str) {
	return fromL3Stream(rdl.parseString(str));
}
exports.parseRdl = parseRdl;
exports.parseRdlString = parseRdlString;

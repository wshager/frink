...
a.put = (...$) => {
	const $len = $.length;
	global.console.log("a.put", $len);
	if ($len == 3) return n.fromPromise(a.put$3.apply(null, $));
};
a.foldLeft = (...$) => {
	const $len = $.length;
	global.console.log("a.foldLeft", $len);
...
a.foldLeftAt = (...$) => {
	const $len = $.length;
	global.console.log("a.foldLeftAt", $len);
...
a.reduceAroundAt = (...$) => {
	const $len = $.length;
	global.console.log("a.reduceAroundAt", $len);
...
a.reduceAheadAt = (...$) => {
	const $len = $.length;
	global.console.log("a.reduceAheadAt", $len);
...
a.foldRight = (...$) => {
	const $len = $.length;
	global.console.log("a.foldRight", $len);
...
a.foldRightAt = (...$) => {
	const $len = $.length;
	global.console.log("a.foldRightAt", $len);
...
a.forEach = (...$) => {
	const $len = $.length;
	global.console.log("a.forEach", $len);
...
a.forEachAt = (...$) => {
	const $len = $.length;
	global.console.log("a.forEachAt", $len);

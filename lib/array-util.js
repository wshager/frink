...
a.put$3 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("array", $(1)),
		$("position", $(2)),
		$("member", $(3)),
		await n.when(n.gt($("position"), array.size($("array")))) ? array.append($("array"), $("member")) : array.insertBefore(array.remove($("array"), $("position")), $("position"), $("member"))
}));
...
a.foldLeft$4 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("array", $(1)),
		...
		$("function", $(3)),
		$("s", $(4)),
		await n.when(n.eq($("s"), 0)) ? $("zero") : a.foldLeft(array.tail($("array")), $("function").call($, $("zero"), array.head($("array"))), $("function"), n.subtract($("s"), 1))
}));
...
a.foldLeftAt$5 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("array", $(1)),
		...
		$("at", $(4)),
		$("s", $(5)),
		await n.when(n.eq($("s"), 0)) ? $("zero") : a.foldLeftAt(array.tail($("array")), $("function").call($, $("zero"), array.head($("array")), $("at")), $("function"), n.add($("at"), 1), n.subtract($("s"), 1))
}));
...
a.foldRight$4 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("array", $(1)),
		...
		$("function", $(3)),
		$("s", $(4)),
		await n.when(n.eq($("s"), 0)) ? $("zero") : a.foldRight(array.remove($("array"), $("s")), $("function").call($, $("zero"), array.get($("array"), $("s"))), $("function"), n.subtract($("s"), 1))
}));
...
a.foldRightAt$4 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("array", $(1)),
		...
		$("function", $(3)),
		$("at", $(4)),
		await n.when(n.eq($("at"), 0)) ? $("zero") : a.foldRightAt(array.remove($("array"), $("at")), $("function").call($, $("zero"), array.get($("array"), $("at")), $("at")), $("function"), n.subtract($("at"), 1))
}));
...
a.forEach$3 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("array", $(1)),
		$("function", $(2)),
		$("ret", $(3)),
		await n.when(n.eq(array.size($("array")), 0)) ? $("ret") : a.forEach(array.tail($("array")), $("function"), array.append($("ret"), $("function").call($, array.head($("array")))))
}));
...
a.forEachAt$4 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item()), n.item()), (async function(...$) {
	...
	return $("array", $(1)),
		...
		$("ret", $(3)),
		$("at", $(4)),
		await n.when(n.eq(array.size($("array")), 0)) ? $("ret") : a.forEachAt(array.tail($("array")), $("function"), array.append($("ret"), $("function").call($, array.head($("array")), $("at"))), n.add($("at"), 1))
}));
	...
	return $("array", $(1)),
		...
		a.foldLeftAt($("array"), n.seq(), n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), (async function(...$) {
			...
			return $("pre", $(1)),
				$("cur", $(2)),
				$("at", $(3)),
				await n.when(n.or(n.empty($("pre")), n.deepEqual($("cur"), $("lookup")))) ? $("at") : $("pre")
		})));
}));
	...
	return $("array", $(1)),
		...
		a.foldRightAt($("array"), 0, n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), (async function(...$) {
			...
			return $("cur", $(1)),
				$("pre", $(2)),
				$("at", $(3)),
				await n.when(n.and(n.eq($("pre"), 0), n.deepEqual($("cur"), $("lookup")))) ? $("at") : $("pre")
		})));
}));
a.put = (...$) => {
	const $len = $.length;

...
a.put$3 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("position", $(2)),
	$("member", $(3)),
	n.when(n.gt($("position"), array.size($("array")))) ?
		(array.append($("array"), $("member"))) :
		(array.insertBefore(array.remove($("array"), $("position")), $("position"), $("member")));
}));
a.foldLeft$3 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("zero", $(2)),
	$("function", $(3)),
...
a.foldLeft$4 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("zero", $(2)),
	$("function", $(3)),
...
a.foldLeftAt$3 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("zero", $(2)),
	$("function", $(3)),
...
a.foldLeftAt$4 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("zero", $(2)),
	$("function", $(3)),
...
a.foldLeftAt$5 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("zero", $(2)),
	$("function", $(3)),
...
a.reduceAroundAt$2 = n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
...
a.reduceAroundAt$3 = n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
	$("zero", $(3)),
...
a.reduceAroundAt$4 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
	$("zero", $(3)),
...
a.reduceAroundAt$5 = n.typed(n.function(n.seq(n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
	$("zero", $(3)),
...
a.reduceAroundAt$6 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item(), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
	$("zero", $(3)),
	...
	$("tmp", a.foldLeft(array.tail($("array")), $("tmp"), n.typed(n.function(n.seq(n.item(), n.item()), n.item()), (function(...$) {
		$ = n.frame($, this);
		return $("tmp", $(1)),
		$("next", $(2)),
...
a.reduceAheadAt$2 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
	a.reduceAheadAt(array.tail($("array")), $("function"), array.head($("array")), n.seq(), 2);
}));
a.reduceAheadAt$3 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
	$("zero", $(3)),
...
a.reduceAheadAt$4 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
	$("zero", $(3)),
...
a.reduceAheadAt$5 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
	$("zero", $(3)),
...
a.foldRight$3 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("zero", $(2)),
	$("function", $(3)),
...
a.foldRight$4 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("zero", $(2)),
	$("function", $(3)),
...
a.foldRightAt$3 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("zero", $(2)),
	$("function", $(3)),
...
a.foldRightAt$4 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("zero", $(2)),
	$("function", $(3)),
...
a.forEach$2 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
	a.forEach($("array"), $("function"), array.array());
}));
a.forEach$3 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
	$("ret", $(3)),
	n.when(n.eq(array.size($("array")), 0)) ?
		($("ret")) :
		(a.forEach(array.tail($("array")), $("function"), array.append($("ret"), $("function").call($, array.head($("array"))))));
}));
a.forEachAt$2 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
	a.forEachAt($("array"), $("function"), array.array(), 1);
}));
a.forEachAt$4 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.item(), n.item(), n.item()), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("function", $(2)),
	$("ret", $(3)),
...
a.last$1 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore()))), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	array.get($("array"), array.size($("array")));
}));
a.pop$1 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore()))), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	array.remove($("array"), array.size($("array")));
}));
a.firstIndexOf$2 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.occurs(n.item(), n.zeroOrOne())), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("lookup", $(2)),
	a.foldLeftAt($("array"), n.seq(), n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), (function(...$) {
		$ = n.frame($, this);
		return $("pre", $(1)),
		$("cur", $(2)),
		$("at", $(3)),
		(n.when(n.empty($("pre"))) || n.when(n.deepEqual($("cur"), $("lookup")))) ?
			($("at")) :
			($("pre"));
	}).bind($)));
}));
a.lastIndexOf$2 = n.typed(n.function(n.seq(n.array(n.occurs(n.item(), n.zeroOrMore())), n.occurs(n.item(), n.zeroOrOne())), n.item()), (function(...$) {
	$ = n.frame($);
	return $("array", $(1)),
	$("lookup", $(2)),
	a.foldRightAt($("array"), 0, n.typed(n.function(n.seq(n.item(), n.item(), n.item()), n.item()), (function(...$) {
		$ = n.frame($, this);
		return $("cur", $(1)),
		$("pre", $(2)),
		$("at", $(3)),
		(n.when(n.eq($("pre"), 0)) && n.when(n.deepEqual($("cur"), $("lookup")))) ?
			($("at")) :
			($("pre"));
	}).bind($)));
}));

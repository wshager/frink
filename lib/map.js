...
var fromEntries = exports.fromEntries = (entries, m = _create()) => {
	m = m.beginMutation();
...
function set($m, $k, $v) {
	return _checked($m, function (m) {
		return (0, _seq.forEach)((0, _seq.exactlyOne)($k,"msetk"), function (k) {
			return (0, _seq.forEach)((0, _seq.exactlyOne)($v,"msetv: "+k), function (v) {
				return m.set(k, v);
			});
		});
	});

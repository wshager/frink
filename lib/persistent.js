...
function collection($uri) {
    var uri = first($uri);
    return seq(readDirSync(uri).map(function (file) {
        return doc(uri + "/" + file);
    }));
}
...
var appendChild = exports.appendChild = md.appendChild.bind(inode);

var insertChildBefore = exports.insertChildBefore = md.insertChildBefore.bind(inode);

var removeChild = exports.removeChild = md.removeChild.bind(inode);
...
var fromL3 = exports.fromL3 = l3.fromL3.bind(inode);

var toL3 = exports.toL3 = l3.toL3.bind(inode);

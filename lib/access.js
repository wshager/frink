...
function _selectImpl(node, path) {
	...
	return _transducers.transform(nodelist, _transducers.compose( /*filter(nodeFilter),*/_transducers.forEach(process), (n,k,i,z) =>
		_seq.isSeq(n) || attr ? _transducers.cat(n,k,i,z) : _transducers.distinctCat(_comparer())(n,k,i,z)
	));
}

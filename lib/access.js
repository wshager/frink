...
function firstChild($node) {
	...
	return _doc.ensureDoc.bind(this)($node).concatMap(function (node) {
		var next = node.first();
...
function nextSibling($node) {
	return _doc.ensureDoc.bind(this)($node).concatMap(function (node) {
		...
		return next ? (0, _seq.seq)(parent.vnode(next, parent, node.depth, node.indexInParent + 1)) : (0, _seq.seq)();
	});
}

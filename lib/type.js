...
function _opReducer(iterable, opfn, other, general) {
    ...
    if (general) {
        return (0, _transducers.foldLeft)(iterable, function (acc, v) {
            return acc || (otherIsSeq ? (0, _transducers.foldLeft)(other, function (pre, cur) {
        ...
        return (0, _transducers.forEach)(iterable, function (v) {
            return otherIsSeq ? (0, _transducers.foldLeft)(other, function (pre, cur) {
                return pre || opfn(v, cur);
            }, false) : opfn(v, other);
        });
    }
...
function dataImpl(node, fltr = false) {
    ...
    if ((0, _seq.isSeq)(node)) {
        ...
        var a = (0, _transducers.filter)(node, _ => undefined !== dataImpl(_, fltr));
        if (!a.size) {

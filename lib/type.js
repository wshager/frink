...
function and($a, $b) {
  return (0, _seq.switchMap)((0, _value2.boolean)($a()), a => a ? (0, _seq.switchMap)((0, _value2.boolean)($b()), impl.and) : false);
}

function or($a, $b) {
  return (0, _seq.switchMap)((0, _value2.boolean)($a()), a => a ? true : (0, _seq.switchMap)((0, _value2.boolean)($b()), impl.or));
}
